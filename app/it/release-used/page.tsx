        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl mb-6">
            ...
            <div className="text-center mb-6">
              ...
              {!profileData && (
                <div>
                  <h2 className="text-white text-2xl font-bold mb-2">La tua analisi è pronta!</h2>
                  <p className="text-gray-400 text-sm">Risultati completi per @{username?.replace('@', '') || 'username'}</p>
                </div>
              )}
            </div>
            ...
            <div className="bg-pink-500/10 border border-pink-500/20 rounded-2xl p-4 mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-pink-200 font-medium text-sm mb-1">Sblocca il rapporto completo</div>
                  <div className="text-pink-300/80 text-xs">Ottieni accesso in tempo reale a tutte le funzionalità:</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Tracciamento stalker</h3>
                  <p className="text-gray-400 text-xs">Scopri chi visita segretamente il tuo profilo</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Notifiche screenshot</h3>
                  <p className="text-gray-400 text-xs">Sappi quando qualcuno cattura i tuoi contenuti</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Spettatori delle storie</h3>
                  <p className="text-gray-400 text-xs">Vedi chi guarda le tue storie ripetutamente</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Tracciamento menzioni</h3>
                  <p className="text-gray-400 text-xs">Traccia chi ti menziona nelle chat private</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-4 mb-6 text-center">
              ...
              <p className="text-gray-400 text-xs">Unisciti alla comunità che ha scoperto la verità</p>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-white/5 rounded-2xl p-4">
                ...
                <p className="text-gray-300 text-xs mb-3 leading-relaxed">
                  "Ho scoperto chi stalka il mio profilo! Vale ogni centesimo!"
                </p>
              ...
              <div className="bg-white/5 rounded-2xl p-4">
                ...
                <p className="text-gray-300 text-xs mb-3 leading-relaxed">
                  "Incredibile! Ora so chi guarda le mie storie ripetutamente."
                </p>
                <div className="flex space-x-1">
                  <span className="text-yellow-400 text-sm">★</span>
                  <span className="text-yellow-400 text-sm">★</span>
            ...
            <div className="border-t border-white/10 pt-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-white text-lg font-bold">Accesso Premium</h3>
              ...
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-green-400 text-sm font-medium">Pagamento 100% sicuro</span>
              </div>
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white text-sm">Accesso a vita</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                  <span className="text-white text-sm">Aggiornamenti in tempo reale</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                  <span className="text-white text-sm">Bonus: Accesso agli amici stretti</span>
                </div>
              </div>
              ...
              >
                Ottieni il rapporto completo ora
              </Button>
            </div>
          </div>
        </div>
