      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-red-600 text-white py-3 px-4">
        <div className="container mx-auto flex items-center justify-center space-x-4">
          <span className="font-semibold text-sm md:text-base">
            🎉 CONGRATULAZIONI! HAI VINTO IL 50% DI SCONTO! 🎉
          </span>
        </div>
      </div>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Il tuo posto nell'applicazione <span className="text-purple-400 font-bold">Instagram Dossier</span> è garantito con protezione.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                Senza questa protezione, la tua applicazione può funzionare con restrizioni di sicurezza e i tuoi dati potrebbero essere in pericolo. Attiva ora la protezione del server.
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Protezione completa delle tue informazioni e della tua privacy.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Monitoraggio 24/7 e backup automatico attivato.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                Attiva ora la protezione e proteggi il tuo accesso!
              </h3>
            </div>
            ...
            <div className="mt-8">
              ...
              >
                🔒 ATTIVA LA PROTEZIONE<br />CON IL 50% DI SCONTO
              </Button>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">Perché ho bisogno di questa protezione?</p>
