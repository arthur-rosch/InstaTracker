...
export function HeroSection() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (stored) {
        ...
        if (data.profile && data.profile.name === cleanUsername) {
          ...
          router.push(`/it/release-used?username=${cleanUsername}`)
          setIsLoading(false)
          return
        }
      }
    ...
    router.push(`/it/confirm?username=${cleanUsername}`)
    setIsLoading(false)
  }
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center space-y-8">
            ...
            <div className="flex items-center justify-center space-x-3 mb-6">
              ...
              <span className="text-lg font-semibold text-purple-400">Scopri in 1 minuto</span>
            </div>
            ...
            <div className="space-y-4">
              <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight">
                ...
                <span className="instagram-gradient-text">Instagram ti nasconde.</span>
              </h1>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
                <div className="relative flex-1">
                  ...
                  <Input
                    type="text"
                    placeholder="Inserisci il nome utente Instagram"
                    value={username}
              ...
              <div className="space-y-1">
                <p className="text-xs text-gray-400">100% Anonimo • Risultati istantanei • Nessuna registrazione richiesta</p>
                <p className="text-xs text-orange-400 font-semibold">⚠️ Una richiesta per dispositivo • Dati memorizzati sul dispositivo</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 max-w-lg mx-auto mb-6">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300">
                ...
                <div className="relative z-10">
                  <h3 className="text-sm font-bold text-white mb-1">Profilo completo</h3>
                  <p className="text-xs text-gray-300">Accesso a tutte le informazioni del profilo, foto, follower e altro</p>
                </div>
              </div>
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300">
                <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-transparent rounded-xl"></div>
                <div className="relative z-10">
                  <h3 className="text-sm font-bold text-white mb-1">Storie e messaggi</h3>
                  <p className="text-xs text-gray-300">Scopri chi ha visto le tue storie e accedi ai messaggi privati</p>
                </div>
              </div>
            </div>
