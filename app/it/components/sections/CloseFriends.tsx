...
export function CloseFriends({ username, profileData, followers, followersLoading }: CloseFriendsProps) {
  ...
  // Verwende nur die ersten 4 Follower für die Avatare
    ...
    <section className="space-y-6">
      <div className="rounded-3xl p-8 text-center">
        ...
        <div className="flex items-center justify-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-white">Amici stretti</h2>
        </div>

        {/* Subtitle */}
        <p className="text-gray-300 text-lg mb-8">
          @{profileData?.name || username} e {displayFollowers.length || 4} altre persone hanno aggiunto questo profilo agli amici stretti
        </p>
        ...
        <p className="text-gray-400 text-sm">
          ...e 2 altre persone che non seguono {username}
        </p>
      </div>
      <div className="pt-4">
        <button
        ...
        >
Visualizza le storie in tempo reale
        </button>
      </div>
