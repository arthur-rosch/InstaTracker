...
const mockActivities = [
  { username: "@d******", action: "Messaggi DM cancellati - 12 volte ieri", icon: Lock },
  { username: "@a******", action: "Aggiunto agli amici stretti", icon: Users },
  { username: "@o******", action: "Ha trascorso +52m in videochiamata con eo.rosch", icon: Clock }
]
  ...
  return (
    <section className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-white mb-2">Attività principali di questa settimana rilevate</h2>
      </div>
      ...
      <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-4 shadow-xl">
        <div className="flex items-center space-x-3">
          ...
          <p className="text-white">Profili sono stati limitati nelle storie e pubblicazioni di {username}</p>
        </div>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
        <div className="mb-4">
          <div className="flex items-center space-x-3 mb-3">
            <div>
              <h3 className="text-white font-bold text-lg">Attività di localizzazione rilevata</h3>
              <p className="text-gray-300 text-sm">Tracciamento della posizione in tempo reale</p>
            </div>
          </div>
        </div>
