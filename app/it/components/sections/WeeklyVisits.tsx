  ...
  return (
    <section className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <h3 className="text-xl font-bold text-white">Settimana scorsa</h3>
        <p className="text-gray-400">16/07 - 22/07</p>
        <p className="text-white font-semibold">Hanno visitato questo profilo questa settimana da 2 a 7 volte:</p>
      </div>
      ...
      <p className="text-center text-orange-400 font-semibold">... e altri:</p>
        ...
        <div className="bg-gradient-to-r from-red-900/30 to-pink-900/30 border border-red-500/30 rounded-2xl p-4 shadow-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-white font-semibold">Follower di {profileData?.name || username} hanno interessi sessuali</p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-orange-900/30 to-red-900/30 border border-orange-500/30 rounded-2xl p-4 shadow-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-white font-semibold">Conversazioni di {profileData?.name || username} in Direct contengono nudità</p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border border-yellow-500/30 rounded-2xl p-4 shadow-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <div className="text-2xl">⚠️</div>
              <div>
                <p className="text-white font-semibold">Profili sono stati limitati nelle storie e pubblicazioni di {profileData?.name || username}</p>
              </div>
            </div>
            <div className="text-2xl">🚫</div>
          </div>
      ...
      <div className="pt-4">
        ...
        >
          {showChatList ? 'Nascondi conversazioni' : 'Visualizza conversazioni in tempo reale'}
        </button>
      </div>
