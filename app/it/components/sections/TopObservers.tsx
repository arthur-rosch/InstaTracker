...
const mockTopObservers = [
  { username: "@g********", action: "42 pubblicazioni salvate" },
  { username: "@d********", action: "65 visite al profilo" },
  { username: "@k********", action: "52 storie visualizzate" }
]
  ...
  return (
    <section className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-xl font-bold text-white mb-2">I tuoi principali osservatori</h3>
        <p className="text-gray-300">Questi profili interagiscono di più con i tuoi contenuti</p>
      </div>
