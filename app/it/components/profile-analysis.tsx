...
const analysisTopics = [
  { label: "Informazioni del profilo", completed: false, threshold: 20 },
  { label: "Interazioni delle storie", completed: false, threshold: 30 },
  { label: "Messaggi diretti", completed: false, threshold: 40 },
  { label: "Lista amici stretti", completed: false, threshold: 50 },
  { label: "Visitatori del profilo", completed: false, threshold: 60 },
  { label: "Contenuti eliminati", completed: false, threshold: 70 },
  { label: "Connessioni nascoste", completed: false, threshold: 80 },
  { label: "Analisi di sicurezza", completed: false, threshold: 90 },
]
...
const reviews = [
  {
    ...
    time: "2 giorni fa",
    rating: 5,
    text: "Pensavo che il mio ex avesse voltato pagina... 😤 Guarda ancora tutte le mie storie. Questa app ha rivelato la verità che dovevo sapere!",
    verified: true,
  ...
  },
  {
    ...
    time: "1 giorno fa",
    rating: 5,
    text: "Finalmente ho scoperto chi controlla il mio profilo quotidianamente! Questa app è incredibile e vale assolutamente la pena! 🔥",
    verified: true,
      ...
      <div className={`relative z-10 px-4 space-y-8 ${showButton ? "pb-24" : "pb-8"}`}>
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-base font-semibold text-white">Raccolta informazioni Instagram</h2>
            <p className="text-gray-300 text-sm">Attendi mentre scaviamo tra milioni di dati</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
            ...
            <p className="text-gray-300 text-sm text-center">
              La tua cronologia di ricerca è sicura e privata. Il proprietario del profilo Instagram non verrà
              notificato della tua ricerca.
            </p>
          </div>

          {/* Analysis Topics - 2x2 Grid */}
          <div className="space-y-4">
            <h3 className="text-white font-semibold">Raccolta dati...</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-2 mb-2">
                <span className="text-2xl font-bold text-white">Eccellente</span>
              ...
              <p className="text-gray-300">
                <span className="font-bold text-white">4.75</span> basato su{" "}
                <span className="font-bold text-white">338</span> recensioni
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-300 text-sm">Cliente verificato</span>
                </div>
          ...
          <div className="space-y-6">
            <p className="text-gray-300 font-medium text-center text-sm">INSTACHECK È STATO PRESENTATO IN</p>
      ...
      {showButton && (
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-black/80 backdrop-blur-xl border-t border-white/10 z-50">
          <div className="max-w-md mx-auto">
            ...
            >
              Accesso Instagram in tempo reale
            </button>
          </div>
        </div>
      )}
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="text-white text-lg">Caricamento dell'analisi...</div>
        <div className="text-gray-400 text-sm mt-2">Attendi mentre prepariamo la tua analisi del profilo</div>
      </div>
    </div>
  )
}
