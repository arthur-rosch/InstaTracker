        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Screenshot</h3>
                <p className="text-gray-400 text-sm">Visualizza screenshot, registrazioni...</p>
              </div>
            </div>
          ...
          <div className="text-center space-y-2">
            <p className="text-white font-bold text-2xl">{prints.length} Screenshot</p>
            <p className="text-purple-400 text-sm">Scorri per vedere le conversazioni recuperate</p>
            <p className="text-gray-400 text-xs">Aggiornato ora</p>
          </div>
        </div>
      </div>
    </div>
