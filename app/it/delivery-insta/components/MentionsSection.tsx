        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Stima delle menzioni</h3>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              <h2 className="text-white font-bold text-4xl md:text-5xl mb-2">{mentionsCount} Menzioni</h2>
            </div>
            ...
            <div className="text-center space-y-2">
              <p className="text-white text-sm md:text-base font-medium">
                Sblocca il Centro di Cattura per vedere i messaggi che
              </p>
              <p className="text-white text-sm md:text-base font-medium">
            ...
            {/* Status */}
            <div className="text-center">
              <p className="text-gray-400 text-sm">Aggiornato ora</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="bg-black/95 border border-white/20 text-white w-[95vw] max-w-lg max-h-[85vh] overflow-hidden">
          <DialogHeader className="flex flex-row items-center justify-between pb-4">
            <DialogTitle className="text-lg md:text-xl font-bold">Persone che ti hanno menzionato ({displayFollowers.length})</DialogTitle>
            <Button
              variant="ghost"
              size="sm"
