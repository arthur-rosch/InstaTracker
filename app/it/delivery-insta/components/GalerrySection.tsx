        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Foto sospette</h3>
                <p className="text-gray-400 text-sm">Contenuto potenzialmente compromettente rilevato</p>
              </div>
            </div>
          ...
          <div className="text-center space-y-3">
            <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4">
              <div className="flex items-center justify-center space-x-2 mb-2">
                ...
                <span className="text-red-400 font-semibold">Allerta privacy</span>
              </div>
              <p className="text-gray-300 text-sm">
                È stato rilevato e catturato contenuto potenzialmente compromettente.
              </p>
            </div>

            <div className="space-y-1">
              <p className="text-white font-bold text-xl">1 Foto sospetta</p>
              <p className="text-red-400 text-sm">Richiede attenzione immediata</p>
              <p className="text-gray-400 text-xs">Ultima rilevazione: Ora</p>
            </div>
          </div>
        </div>
      </div>
