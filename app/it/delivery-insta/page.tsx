        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12 mt-8">
              ...
              <p className="text-gray-300 text-lg mb-8">Rapporto di attività completo per @{currentUsername}</p>
              ...
              <div className="inline-block bg-white/5 backdrop-blur-xl border border-purple-400/30 rounded-2xl px-6 py-4 mb-6 shadow-2xl">
                ...
                <div className="relative z-10 flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-purple-300 text-sm">Analisi Instagram completa</p>
                  </div>
                  <button
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="text-white font-bold text-lg md:text-xl">Messaggi temporanei</h3>
                        <p className="text-gray-300 text-sm">Recupero dei messaggi temporanei eliminati</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-purple-400/30 rounded-xl p-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <h4 className="text-white font-semibold">Aggirare la protezione</h4>
                          <p className="text-gray-300 text-sm">Aggiramento della protezione dei messaggi temporanei...</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-pink-400/30 rounded-xl p-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <h4 className="text-white font-semibold">Recupero media</h4>
                          <p className="text-gray-300 text-sm">Ricerca di foto e video temporanei degli ultimi 30 giorni...</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-blue-400/30 rounded-xl p-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <h4 className="text-white font-semibold">Analisi delle interazioni</h4>
                          <p className="text-gray-300 text-sm">Identificazione di modelli di interazione sospetti...</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-orange-500/10 border border-orange-400/30 rounded-xl p-4 mb-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="text-white font-semibold">Analisi in corso</h4>
                        <p className="text-gray-300 text-sm">Il rapporto dettagliato con analisi approfondita del profilo sarà disponibile tra 7 giorni.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-400/30 rounded-xl p-6 mb-6">
                    <div className="text-center mb-4">
                      <h4 className="text-white font-bold text-lg mb-2">🎁 Bonus esclusivo!</h4>
                      <p className="text-gray-300">Riceverai il MemberKit completo via email entro 24 ore con oltre 1000$ di contenuti gratuiti!</p>
                    </div>

                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4">
                      <h5 className="text-purple-300 font-semibold mb-3">📧 Cosa riceverai:</h5>
                      <ul className="space-y-2 text-gray-300 text-sm">
                        <li className="flex items-center space-x-2">
                          <span className="w-2 h-2 bg-purple-400 rounded-full"></span>
                          <span>Accesso completo al MemberKit</span>
                        </li>
                        <li className="flex items-center space-x-2">
                          <span className="w-2 h-2 bg-purple-400 rounded-full"></span>
                          <span>Oltre 1000$ di contenuti premium</span>
                        </li>
                        <li className="flex items-center space-x-2">
                          <span className="w-2 h-2 bg-purple-400 rounded-full"></span>
                          <span>Inviato direttamente alla tua email</span>
                        </li>
                      </ul>
                      <p className="text-yellow-400 text-sm mt-3 font-semibold">Controlla la tua casella di posta e la cartella spam</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-white/5 backdrop-blur-xl border border-red-400/30 rounded-xl p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-red-400 text-sm font-semibold">Messaggio temporaneo</span>
                      </div>
                    </div>
