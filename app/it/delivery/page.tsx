  ...
  const services = [
    {
      id: "instagram",
      name: "Instagram",
      description: "Vedere i DM, Stalker, Reindirizzamenti...",
    ...
    },
    {
      id: "whatsapp",
      name: "WhatsApp",
      description: "Vedere le conversazioni, chiamate...",
    ...
    },
    {
      id: "facebook",
      name: "Facebook",
      description: "Accedere a Messenger, recuperare le conversazioni...",
    ...
    },
    {
      id: "location",
      name: "Localisation",
      description: "Mostrare la posizione della persona sorvegliata in tempo reale.",
      icon: MapPin,
      status: "Inactif"
    },
    {
      id: "social",
      name: "Social network",
      description: "Mostrare tutti i social network di questa persona. Es: Tinder",
    ...
    },
    {
      id: "camera",
      name: "Fotocamera",
      description: "Ottenere l'accesso alla fotocamera e al microfono del telefono...",
      icon: Camera,
      status: "Inactif"
    },
    {
      id: "gallery",
      name: "Galleria",
      description: "Vedere la galleria foto, album segreti, foto eliminate...",
    ...
    },
    {
      id: "adult",
      name: "+18",
      description: "Accedere al contenuto per adulti e video privati...",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 mt-12 mx-4">
            ...
            <div className="inline-block bg-white/5 backdrop-blur-xl border border-purple-400/30 rounded-2xl px-6 py-4 mb-6 shadow-2xl">
              ...
              <div className="relative z-10 flex items-center space-x-3">
                ...
                <div className="text-left">
                  <h2 className="text-white font-bold text-lg">Benvenuto!</h2>
                  <p className="text-purple-300 text-sm">Hai 1 rapporto disponibile questa settimana.</p>
                </div>
            ...
            <p className="text-gray-300 text-lg mb-8">disponibili per te</p>
          </div>
            ...
            {services.map((service) => {
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    if (service.id === 'instagram' && service.status === 'Actif') {
                      router.push('/it/delivery-insta')
                    } else {
                    ...
                    <div className="flex flex-col space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <div className={`px-2 py-1 rounded-full text-xs font-bold backdrop-blur-sm ${isActive
                          ...
                          {service.status === 'Actif' ? 'Attivo' : 'Inattivo'}
                        </div>
                      </div>
                      <div>
