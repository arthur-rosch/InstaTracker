...
function ReportContent() {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      // Aspetta un po' per simulare il caricamento completo
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-white text-lg">Caricamento del rapporto...</div>
          <div className="text-gray-400 text-sm mt-2">Attendi mentre elaboriamo i dati</div>
        </div>
      </div>
    )
  }
