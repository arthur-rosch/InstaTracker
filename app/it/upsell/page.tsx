...
NON LASCIARE QUESTA PAGINA, POTREBBE CAUSARE PERDITA DI DATI!
          </span>
        </div>
      </div>
      ...
      <section className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex flex-col justify-center relative overflow-hidden pt-16 pb-24">
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-md">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <h1 className="text-white text-lg font-semibold">Aggiornamento</h1>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Il tuo posto nell'applicazione <span className="text-purple-400 font-bold">Instagram Dossier</span> è garantito.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                A causa del grande volume di dati compromettenti cancellati trovati su Instagram, dobbiamo aggiornare il pacchetto firewall per rivelare tutti i dati compromettenti. Se scegli "Perdere i dati", la tua indagine potrebbe essere persa per sempre.
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Garantisce la rivelazione di tutti i tuoi dati e scopri la verità una volta per tutte.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Ti fidi abbastanza da ignorare la verità?
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                Sbloccalo ora e usa la tua applicazione in modo ottimale!
              </h3>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-6 border-2 border-red-500">
              ...
              <p className="text-white text-sm font-semibold mb-3">L'OFFERTA SCADE TRA</p>
            ...
            <div className="mt-8">
              ...
              >
                🔥 CLICCA QUI PER ACCEDERE<br />A TUTTI I DATI
              </Button>
            </div>

            {/* FAQ Section */}
            <div className="mt-12">
              <h3 className="text-purple-400 text-xl font-bold mb-4">DOMANDE FREQUENTI</h3>
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">Perché devo pagare queste commissioni?</p>
