      ...
      <section className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex flex-col justify-center relative overflow-hidden pt-16 pb-24">
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-md">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <h1 className="text-white text-lg font-semibold">Ultima offerta</h1>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Ottieni accesso base all'applicazione <span className="text-purple-400 font-bold">Instagram Dossier</span> con funzionalità essenziali.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                Questa è la tua ultima possibilità di ottenere l'accesso all'applicazione Instagram Dossier a prezzo ridotto. Non perdere questa opportunità finale!
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Funzionalità di tracciamento essenziali per le attività Instagram.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Report di base e supporto email standard.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                Ottieni ora l'accesso base con il 70% di sconto!
              </h3>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-6 border-2 border-red-500">
              <div className="flex items-center justify-center space-x-2 mb-2">
                <span className="text-white text-sm font-semibold">🚨 CONTO ALLA ROVESCIA FINALE</span>
              </div>
              ...
              <p className="text-white text-sm font-bold mt-3">
                ULTIMA POSSIBILITÀ - NON PERDERLA!
              </p>
            ...
            <div className="mt-8">
              ...
              >
                📱 OTTIENI L'ACCESSO BASE<br />CON IL 70% DI SCONTO
              </Button>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">Cosa include l'accesso base?</p>
