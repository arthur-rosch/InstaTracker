        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12 mt-8">
              ...
              <p className="text-gray-300 text-lg mb-8">Rapport d'activité complet pour @{currentUsername}</p>
              ...
              <div className="inline-block bg-white/5 backdrop-blur-xl border border-purple-400/30 rounded-2xl px-6 py-4 mb-6 shadow-2xl">
                ...
                <div className="relative z-10 flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-purple-300 text-sm">Analyse Instagram complète</p>
                  </div>
                  <button
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="text-white font-bold text-lg md:text-xl">Messages temporaires</h3>
                        <p className="text-gray-300 text-sm">Récupération des messages temporaires supprimés</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-purple-400/30 rounded-xl p-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <h4 className="text-white font-semibold">Contourner la protection</h4>
                          <p className="text-gray-300 text-sm">Contournement de la protection des messages temporaires...</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-pink-400/30 rounded-xl p-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <h4 className="text-white font-semibold">Récupération de médias</h4>
                          <p className="text-gray-300 text-sm">Recherche de photos et vidéos temporaires des 30 derniers jours...</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-blue-400/30 rounded-xl p-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <h4 className="text-white font-semibold">Analyse des interactions</h4>
                          <p className="text-gray-300 text-sm">Identification des modèles d'interaction suspects...</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-orange-500/10 border border-orange-400/30 rounded-xl p-4 mb-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="text-white font-semibold">Analyse en cours</h4>
                        <p className="text-gray-300 text-sm">Le rapport détaillé avec analyse de profil approfondie sera disponible dans 7 jours.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-400/30 rounded-xl p-6 mb-6">
                    <div className="text-center mb-4">
                      <h4 className="text-white font-bold text-lg mb-2">🎁 Bonus exclusif !</h4>
                      <p className="text-gray-300">Tu recevras le MemberKit complet par e-mail dans 24 heures avec plus de 1000$ de contenu gratuit !</p>
                    </div>

                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4">
                      <h5 className="text-purple-300 font-semibold mb-3">📧 Ce que tu recevras :</h5>
                      <ul className="space-y-2 text-gray-300 text-sm">
                        <li className="flex items-center space-x-2">
                          <span className="w-2 h-2 bg-purple-400 rounded-full"></span>
                          <span>Accès complet au MemberKit</span>
                        </li>
                        <li className="flex items-center space-x-2">
                          <span className="w-2 h-2 bg-purple-400 rounded-full"></span>
                          <span>Plus de 1000$ de contenu premium</span>
                        </li>
                        <li className="flex items-center space-x-2">
                          <span className="w-2 h-2 bg-purple-400 rounded-full"></span>
                          <span>Envoyé directement à ton e-mail</span>
                        </li>
                      </ul>
                      <p className="text-yellow-400 text-sm mt-3 font-semibold">Vérifie ta boîte de réception et ton dossier spam</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-white/5 backdrop-blur-xl border border-red-400/30 rounded-xl p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-red-400 text-sm font-semibold">Message temporaire</span>
                      </div>
                    </div>
          ...
          <div className="text-center mb-12">
            ...
            <div className="inline-block bg-white/5 backdrop-blur-xl border border-purple-400/30 rounded-2xl px-6 py-4 mb-6 shadow-2xl">
              ...
              <div className="relative z-10 flex items-center space-x-3">
                ...
                <div className="text-left">
                  <h2 className="text-white font-bold text-xl">Espion Instagram</h2>
                  <p className="text-purple-300 text-sm">Accès aux DMs, Stalkers, Redirections...</p>
                </div>
              </div>
            </div>
            ...
            <div className="inline-block bg-green-500/20 backdrop-blur-xl border border-green-400/30 rounded-2xl px-6 py-4 mb-6 shadow-2xl">
              ...
              <div className="relative z-10 flex items-center space-x-3">
                <div className="text-left">
                  <p className="text-green-500/80 text-sm font-semibold">Ton achat a été approuvé !</p>
                </div>
              </div>
            </div>
            ...
            <p className="text-gray-300 text-sm mb-8">
              Tu peux accéder à cette plateforme à tout moment via le lien dans ton e-mail
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Saisis uniquement le nom d'utilisateur, sans le symbole @
                  </p>
                </div>
