        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Contenu</h3>
                <p className="text-gray-300 text-sm">Voir les Stories, publications, contenu partagé...</p>
              </div>
            </div>
          ...
          <div className="space-y-6 mt-6">
            <div className="space-y-4">
              <h4 className="text-white font-semibold text-base">Type de contenu le plus partagé</h4>
            ...
            <div className="space-y-4">
              <h4 className="text-white font-semibold text-base">Contenu partagé cette semaine</h4>
              <div className="bg-white/5 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-300 text-sm">Total partagé</span>
                  <span className="text-white font-medium">{Math.floor(Math.random() * 100) + 50}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-300 text-sm">Moyenne par jour</span>
