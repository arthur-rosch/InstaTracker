...
export default function PrintsSection({ isActive, followers }: PrintsSectionProps) {
  ...
  const generatePrints = (followers: Follower[]) => {
    const messageTemplates = [
      [
        { text: "Que fais-tu ce week-end ?", time: "14:32", isRead: true },
        { text: "Pourquoi ? Tu me manques ?😏", time: "14:35", isRead: true, sender: "me" },
        { text: "HAHA un peu 🙈", time: "14:36", isRead: false }
      ],
      [
        { text: "As-tu vu ma story hier ?", time: "22:15", isRead: true },
        { text: "Oui, je l'ai vue... tu étais magnifique 🔥", time: "22:18", isRead: true, sender: "me" },
        { text: "Merci, chéri ❤️ Tu me manques", time: "22:20", isRead: false }
      ],
      [
        { text: "Salut mon cœur 😘", time: "19:45", isRead: true },
        { text: "Salut princesse, comment s'est passée ta journée ?", time: "19:50", isRead: true, sender: "me" },
        { text: "Mieux maintenant que tu as répondu 💕", time: "19:52", isRead: false }
      ],
      [
        { text: "Tu me manques...", time: "23:30", isRead: true },
        { text: "Moi aussi... quand peut-on se voir ?", time: "23:33", isRead: true, sender: "me" },
        { text: "Demain ? Mes parents ne sont pas à la maison 😏", time: "23:35", isRead: false }
      ]
    ];
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Screenshots</h3>
                <p className="text-gray-400 text-sm">Voir les captures d'écran, enregistrements...</p>
              </div>
            </div>
          ...
          <div className="text-center space-y-2">
            <p className="text-white font-bold text-2xl">{prints.length} Screenshots</p>
            <p className="text-purple-400 text-sm">Glisse pour voir les conversations récupérées</p>
            <p className="text-gray-400 text-xs">Mis à jour maintenant</p>
          </div>
        </div>
      </div>
    </div>
