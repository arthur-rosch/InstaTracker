        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Localisation</h3>
                <p className="text-gray-300 text-sm">Le téléphone que vous souhaitez surveiller a été récemment localisé à cet endroit</p>
              </div>
            </div>
