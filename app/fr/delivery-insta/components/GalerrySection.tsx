        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Photos suspectes</h3>
                <p className="text-gray-400 text-sm">Contenu potentiellement compromettant détecté</p>
              </div>
            </div>
          ...
          <div className="text-center space-y-3">
            <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4">
              <div className="flex items-center justify-center space-x-2 mb-2">
                ...
                <span className="text-red-400 font-semibold">Alerte confidentialité</span>
              </div>
              <p className="text-gray-300 text-sm">
                Du contenu potentiellement compromettant a été détecté et capturé.
              </p>
            </div>

            <div className="space-y-1">
              <p className="text-white font-bold text-xl">1 Photo suspecte</p>
              <p className="text-red-400 text-sm">Nécessite une attention immédiate</p>
              <p className="text-gray-400 text-xs">Dernière détection : À l'instant</p>
            </div>
          </div>
        </div>
      </div>
