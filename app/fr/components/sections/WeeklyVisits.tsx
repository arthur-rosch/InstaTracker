  ...
  return (
    <section className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <h3 className="text-xl font-bold text-white">Semaine dernière</h3>
        <p className="text-gray-400">16/07 - 22/07</p>
        <p className="text-white font-semibold">Ont visité ce profil cette semaine 2 à 7 fois :</p>
      </div>
      ...
      <p className="text-center text-orange-400 font-semibold">... et plus :</p>
        ...
        <div className="bg-gradient-to-r from-red-900/30 to-pink-900/30 border border-red-500/30 rounded-2xl p-4 shadow-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-white font-semibold">Abonnés de {profileData?.name || username} ont des intérêts sexuels</p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-orange-900/30 to-red-900/30 border border-orange-500/30 rounded-2xl p-4 shadow-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-white font-semibold">Conversations de {profileData?.name || username} en Direct contiennent de la nudité</p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border border-yellow-500/30 rounded-2xl p-4 shadow-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <div className="text-2xl">⚠️</div>
              <div>
                <p className="text-white font-semibold">Profils ont été restreints dans les stories et publications de {profileData?.name || username}</p>
              </div>
            </div>
            <div className="text-2xl">🚫</div>
          </div>
      ...
      <div className="pt-4">
        ...
        >
          {showChatList ? 'Masquer les conversations' : 'Voir les conversations en temps réel'}
        </button>
      </div>
