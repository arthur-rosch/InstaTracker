...
const mockTopObservers = [
  { username: "@g********", action: "42 publications sauvegardées" },
  { username: "@d********", action: "65 visites de profil" },
  { username: "@k********", action: "52 stories vues" }
]
  ...
  return (
    <section className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-xl font-bold text-white mb-2">Tes principaux observateurs</h3>
        <p className="text-gray-300">Ces profils interagissent le plus avec ton contenu</p>
      </div>
