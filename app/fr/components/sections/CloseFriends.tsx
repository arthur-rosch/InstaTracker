    ...
    <section className="space-y-6">
      <div className="rounded-3xl p-8 text-center">
        ...
        <div className="flex items-center justify-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-white">Amis proches</h2>
        </div>

        {/* Subtitle */}
        <p className="text-gray-300 text-lg mb-8">
          @{profileData?.name || username} et {displayFollowers.length || 4} autres personnes ont ajouté ce profil aux amis proches
        </p>
        ...
        <p className="text-gray-400 text-sm">
          ...et 2 autres personnes qui ne suivent pas {username}
        </p>
      </div>
      <div className="pt-4">
        <button
        ...
        >
Voir les stories en temps réel
        </button>
      </div>
