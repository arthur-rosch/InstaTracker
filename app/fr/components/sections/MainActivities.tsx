...
const mockActivities = [
  { username: "@d******", action: "Messages DM supprimés - 12 fois hier", icon: Lock },
  { username: "@a******", action: "Ajouté aux amis proches", icon: Users },
  { username: "@o******", action: "A passé +52m en appel vidéo avec eo.rosch", icon: Clock }
]
  ...
  return (
    <section className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-white mb-2">Activités principales de cette semaine détectées</h2>
      </div>
...
Accès à Instagram en temps réel
      ...
      <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-4 shadow-xl">
        <div className="flex items-center space-x-3">
          ...
          <p className="text-white">Profils ont été restreints dans les stories et publications de {username}</p>
        </div>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
        <div className="mb-4">
          <div className="flex items-center space-x-3 mb-3">
            <div>
              <h3 className="text-white font-bold text-lg">Activité de localisation détectée</h3>
              <p className="text-gray-300 text-sm">Suivi de localisation en temps réel</p>
            </div>
          </div>
        </div>
