...
const mockInteractions = [
  { text: "5 captures d'écran de tes stories", icon: Eye },
  { text: "A vu tes stories 13 fois", icon: Eye },
  { text: "A partagé tes stories 13 fois", icon: UserCheck },
  { text: "A sauvegardé 15 de tes publications", icon: Heart }
]
  ...
  return (
    <section className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-white mb-2">Interactions détectées</h2>
      </div>
