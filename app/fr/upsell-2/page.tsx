...
export default function Upsell2Page() {
  ...
  const compromisingMessages1: ChatMessage[] = [
    {
      id: 1,
      content: "Hey, tu es libre ce soir ? 😏",
      type: 'received',
      time: '11:30 PM'
    },
    {
      id: 2,
      content: "Oui, chez moi ou chez toi ? 😘",
      type: 'sent',
      time: '11:32 PM'
    },
    {
      id: 3,
      content: "Chez moi... j'ai prévu quelque chose de spécial 🔥",
      type: 'received',
      time: '11:33 PM'
    },
    {
      id: 4,
      content: "Ça me rend curieuse... quel genre de spécial ? 😈",
      type: 'sent',
      time: '11:34 PM'
    },
    {
    ...
    {
      id: 6,
      content: "Wow... tu es incroyable 🔥🔥",
      type: 'sent',
      time: '11:36 PM'
    },
    {
      id: 7,
      content: "Ce n'est que le début... attends de voir ce que je porte en dessous 😏",
      type: 'received',
      time: '11:37 PM'
    },
    {
      id: 8,
      content: "Tu me rends folle... j'arrive 🚗💨",
      type: 'sent',
      time: '11:38 PM'
    },
    {
      id: 9,
      content: "Bien... je t'attendrai à la porte. Ne frappe pas, entre directement 😈",
      type: 'received',
      time: '11:39 PM'
    },
    {
      id: 10,
      content: "J'ai hâte de te voir... j'ai une surprise 😈",
      type: 'received',
      time: '11:40 PM'
    },
    {
      id: 11,
      content: "Quelle surprise ? Tu me tues d'impatience 🔥",
      type: 'sent',
      time: '11:41 PM'
    },
    {
      id: 12,
      content: "Je me prépare déjà... ça va être incroyable 💋",
      type: 'sent',
      time: '11:42 PM'
    },
    {
      id: 13,
      content: "Disons que... tu ne seras pas déçue. J'y ai pensé toute la journée 😍",
      type: 'received',
      time: '11:43 PM'
    },
    {
      id: 14,
      content: "Moi aussi... je n'arrivais pas à me concentrer sur autre chose au travail aujourd'hui 💭",
      type: 'sent',
      time: '11:44 PM'
    },
    {
      id: 15,
      content: "Bien... car cette nuit sera inoubliable 🌙✨",
      type: 'received',
      time: '11:45 PM'
    },
    {
      id: 16,
      content: "Je suis presque arrivée... mon cœur bat la chamade 💓",
      type: 'sent',
      time: '11:47 PM'
    },
    {
      id: 17,
      content: "Le mien aussi... j'ai hâte de sentir ton toucher à nouveau 😘",
      type: 'received',
      time: '11:48 PM'
    },
    {
      id: 18,
      content: "Je viens d'arriver... on se voit dans 30 secondes 😏",
      type: 'sent',
      time: '11:50 PM'
    }
  ];
  ...
  const compromisingMessages2: ChatMessage[] = [
    {
      id: 1,
      content: "Je n'arrive pas à arrêter de penser à la nuit dernière... 😍",
      type: 'received',
      time: '2:15 AM'
    },
    {
      id: 2,
      content: "Moi non plus... tu étais incroyable 🔥",
      type: 'sent',
      time: '2:17 AM'
    },
    {
      id: 3,
      content: "La façon dont tu m'as regardée... me donne encore des frissons 😊",
      type: 'received',
      time: '2:18 AM'
    },
    {
      id: 4,
      content: "Tu as cet effet sur moi que je ne peux pas expliquer... c'est enivrant 💫",
      type: 'sent',
      time: '2:19 AM'
    },
    {
      id: 5,
      content: "Quand peut-on recommencer ? Tu me manques déjà...",
      type: 'received',
      time: '2:20 AM'
    },
    {
      id: 6,
      content: "Tu me manques aussi... plus que je ne devrais l'admettre 💭",
      type: 'sent',
      time: '2:21 AM'
    },
    {
      id: 7,
      content: "Je repasse chaque moment dans ma tête... surtout ce que tu as fait 😏",
      type: 'received',
      time: '2:22 AM'
    },
    {
      id: 8,
      content: "Quelle partie ? Il y a eu tellement de moments incroyables 😈",
      type: 'sent',
      time: '2:23 AM'
    },
    {
      id: 9,
      content: "Tu sais exactement quelle partie... quand tu m'as chuchoté à l'oreille 🔥",
      type: 'received',
      time: '2:24 AM'
    },
    {
    ...
    {
      id: 11,
      content: "OMG... tu me rends folle 😈💦",
      type: 'received',
      time: '2:26 AM'
    },
    {
      id: 12,
      content: "Je ne peux pas m'en empêcher... tu fais ressortir ce côté de moi 😍",
      type: 'sent',
      time: '2:27 AM'
    },
    {
      id: 13,
      content: "J'adore ce côté de toi... si passionné, si intense 🔥",
      type: 'received',
      time: '2:28 AM'
    },
    {
      id: 14,
      content: "Seulement avec toi... tu me fais ressentir des choses que je n'ai jamais ressenties avant 💕",
      type: 'sent',
      time: '2:29 AM'
    },
    {
      id: 15,
      content: "Demain soir ? Même heure, même passion ? 😘",
      type: 'sent',
      time: '2:30 AM'
    },
    {
      id: 16,
      content: "Oui... mais cette fois on va faire encore plus spécial 🌹",
      type: 'received',
      time: '2:31 AM'
    },
    {
      id: 17,
      content: "J'ai quelques idées... des choses que je voulais essayer avec toi 😏",
      type: 'received',
      time: '2:32 AM'
    },
    {
      id: 18,
      content: "Maintenant tu me rends curieuse... et excitée 😈",
      type: 'sent',
      time: '2:33 AM'
    },
    {
      id: 19,
      content: "Bien... car demain soir sera encore mieux que la nuit dernière 🔥",
      type: 'received',
      time: '2:34 AM'
    },
    {
      id: 20,
      content: "Je ne sais pas comment c'est possible... mais je te fais confiance 💋",
      type: 'sent',
      time: '2:35 AM'
    }
  ];
    ...
    const mockConversations: Conversation[] = [
      {
        ...
        message: "Hey, tu es libre ce soir ? 😏",
        time: "2m",
        isUnlocked: true
      },
      {
        ...
        message: "Je n'arrive pas à arrêter de penser à la nuit dernière... 😍",
        time: "5m",
        isUnlocked: true
      },
      {
        ...
        message: "Merci pour la recommandation !",
        time: "1h",
        muted: true,
      },
      {
        ...
        message: "La fête était incroyable !",
        time: "2h",
      },
      {
        id: 5,
        ...
        message: "Prenons un café bientôt",
        time: "3h",
      },
      {
        id: 6,
        ...
        message: "C'était génial de te rencontrer hier !",
        time: "4h",
      },
      {
        id: 7,
        ...
        message: "Peux-tu m'envoyer ce lien ?",
        time: "5h",
        muted: true,
      },
      {
        ...
        message: "On se voit à la salle de sport !",
        time: "6h",
      },
      {
        id: 9,
        ...
        message: "Merci pour l'aide aujourd'hui",
        time: "7h",
      },
      {
        id: 10,
        ...
        message: "Soirée film ce week-end ?",
        time: "8h",
      },
      {
        id: 11,
        ...
        message: "J'adore ta nouvelle photo de profil !",
        time: "9h",
        muted: true,
      },
      {
      ...
      },
      {
        ...
        message: "Le dîner était incroyable !",
        time: "11h",
        muted: true,
      },
      {
        ...
        message: "Bonne chance pour ta présentation",
        time: "12h",
        muted: true,
      },
      {
        ...
        message: "J'ai hâte pour les vacances !",
        time: "13h",
        muted: true,
      },
      {
      ...
      },
      {
        ...
        message: "Excellent travail sur le projet",
        time: "16h",
        muted: true,
      }
    ];
    ...
    followersData.forEach((follower, index) => {
      if (index < 18) {
        conversations.push({
          ...
          message: index === 0 ? "Hey, tu es libre ce soir ? 😏" :
            index === 1 ? "Je n'arrive pas à arrêter de penser à la nuit dernière... 😍" :
              index < 5 ? "Salut ! Comment ça va ?" :
                index < 10 ? "Merci pour la recommandation !" :
                  "Prenons un café bientôt",
          time: index === 0 ? "2m" :
            index === 1 ? "5m" :
              index < 5 ? "1h" :
                index < 10 ? "2h" : "3h",
      ...
      if (storedData) {
        try {
          ...
          if (parsedData.followers && parsedData.followers.length > 0) {
            console.log('Utilisation des abonnés depuis localStorage:', parsedData.followers);
            const newConversations = createConversationsFromFollowers(parsedData.followers);
            setConversations(newConversations);
          } else {
            console.log('Aucun abonné trouvé dans localStorage, utilisation de données fictives');
          ...
          <div className="text-center p-6">
            <div className="mb-6">
              ...
              <h2 className="text-xl font-bold text-white mb-3">
                Messages secrets découverts !
              </h2>
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                Nous avons trouvé des messages cachés et supprimés dans cette conversation. Cliquez ci-dessous pour révéler tout le contenu secret.
              </p>
            </div>
