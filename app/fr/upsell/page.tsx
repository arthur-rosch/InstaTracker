...
NE QUITTEZ PAS CETTE PAGE, CELA PEUT ENTRAÎNER UNE PERTE DE DONNÉES !
          </span>
        </div>
      </div>
      ...
      <section className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex flex-col justify-center relative overflow-hidden pt-16 pb-24">
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-md">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <h1 className="text-white text-lg font-semibold">Mettre à jour</h1>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Votre place dans l'application <span className="text-purple-400 font-bold">Instagram Dossier</span> est garantie.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                En raison du grand volume de données supprimées compromettantes trouvées sur Instagram, nous devons mettre à jour le package firewall pour révéler toutes les données compromettantes. Si vous choisissez "Perdre les données", votre enquête pourrait être perdue à jamais.
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Garantit la révélation de toutes vos données et découvrez la vérité une fois pour toutes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Faites-vous assez confiance pour ignorer la vérité ?
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                Débloquez-le maintenant et utilisez votre application de manière optimale !
              </h3>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-6 border-2 border-red-500">
              ...
              <p className="text-white text-sm font-semibold mb-3">L'OFFRE EXPIRE DANS</p>
            ...
            <div className="mt-8">
              ...
              >
                🔥 CLIQUEZ ICI POUR ACCÉDER<br />À TOUTES LES DONNÉES
              </Button>
            </div>

            {/* FAQ Section */}
            <div className="mt-12">
              <h3 className="text-purple-400 text-xl font-bold mb-4">QUESTIONS FRÉQUEMMENT POSÉES</h3>
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">Pourquoi dois-je payer ces frais ?</p>
