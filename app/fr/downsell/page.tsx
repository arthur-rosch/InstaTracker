      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-red-600 text-white py-3 px-4">
        <div className="container mx-auto flex items-center justify-center space-x-4">
          <span className="font-semibold text-sm md:text-base">
            🎉 FÉLICITATIONS ! VOUS AVEZ GAGNÉ 50% DE RÉDUCTION ! 🎉
          </span>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-md">
          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-2">
              ...
              <p className="text-purple-400 text-2xl font-bold">75%</p>
            </div>

            {/* Guarantee Message */}
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Votre place dans l'application <span className="text-purple-400 font-bold">Instagram Dossier</span> est garantie avec protection.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                Sans cette protection, votre application peut fonctionner avec des restrictions de sécurité et vos données pourraient être en danger. Activez maintenant la protection du serveur.
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Protection complète de vos informations et de votre vie privée.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Surveillance 24/7 et sauvegarde automatique activée.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                Activez maintenant la protection et sécurisez votre accès !
              </h3>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-6 border-2 border-red-500">
              ...
              <p className="text-white text-sm font-bold mt-3">
                NE PERDEZ PAS VOTRE PROTECTION !
              </p>
            ...
            <div className="mt-8">
              ...
              >
                🔒 ACTIVER LA PROTECTION<br />AVEC 50% DE RÉDUCTION
              </Button>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">Pourquoi ai-je besoin de cette protection ?</p>
