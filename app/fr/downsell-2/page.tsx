      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-red-600 text-white py-3 px-4">
        <div className="container mx-auto flex items-center justify-center space-x-4">
          <span className="font-semibold text-sm md:text-base">
            🎉 DERNIÈRE OFFRE - 70% DE RÉDUCTION ! 🎉
          </span>
        </div>
      </div>
      ...
      <section className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex flex-col justify-center relative overflow-hidden pt-16 pb-24">
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-md">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <h1 className="text-white text-lg font-semibold">Dernière offre</h1>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Obtenez un accès de base à l'application <span className="text-purple-400 font-bold">Instagram Dossier</span> avec des fonctionnalités essentielles.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                C'est votre dernière chance d'obtenir l'accès à l'application Instagram Dossier à un prix réduit. Ne manquez pas cette opportunité finale !
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Fonctionnalités de suivi essentielles pour les activités Instagram.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Rapports de base et support e-mail standard.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                Obtenez maintenant l'accès de base avec 70% de réduction !
              </h3>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-6 border-2 border-red-500">
              <div className="flex items-center justify-center space-x-2 mb-2">
                <span className="text-white text-sm font-semibold">🚨 COMPTE À REBOURS FINAL</span>
              </div>
              ...
              <p className="text-white text-sm font-bold mt-3">
                DERNIÈRE CHANCE - NE LA MANQUEZ PAS !
              </p>
            ...
            <div className="mt-8">
              ...
              >
                📱 OBTENIR L'ACCÈS DE BASE<br />AVEC 70% DE RÉDUCTION
              </Button>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">Que comprend l'accès de base ?</p>
