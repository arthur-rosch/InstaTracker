  ...
  const services = [
    {
      id: "instagram",
      name: "Instagram",
      description: "Voir les DMs, Stalkers, Redirections...",
    ...
    },
    {
      id: "whatsapp",
      name: "WhatsApp",
      description: "Voir les conversations, appels...",
    ...
    },
    {
      id: "facebook",
      name: "Facebook",
      description: "Accéder à Messenger, récupérer les conversations...",
    ...
    },
    {
      id: "location",
      name: "Localisation",
      description: "Afficher la localisation de la personne surveillée en temps réel.",
      icon: MapPin,
      status: "Inactif"
    },
    {
      ...
      description: "Afficher tous les réseaux sociaux de cette personne. Ex: Tinder",
    ...
    },
    {
      id: "camera",
      name: "Caméra",
      description: "Obtenir l'accès à la caméra et au microphone du téléphone...",
      icon: Camera,
      status: "Inactif"
    },
    {
      id: "gallery",
      name: "Galerie",
      description: "Voir la galerie photo, albums secrets, photos supprimées...",
    ...
    },
    {
      id: "adult",
      name: "+18",
      description: "Accéder au contenu adulte et vidéos privées...",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 mt-12 mx-4">
            ...
            <div className="inline-block bg-white/5 backdrop-blur-xl border border-purple-400/30 rounded-2xl px-6 py-4 mb-6 shadow-2xl">
              ...
              <div className="relative z-10 flex items-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-purple-300 text-sm">Tu as 1 rapport disponible cette semaine.</p>
                </div>
            ...
            <p className="text-gray-300 text-lg mb-8">disponibles pour toi</p>
          </div>
