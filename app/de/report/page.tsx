    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-white text-lg">Bericht wird geladen...</div>
          <div className="text-gray-400 text-sm mt-2">Bitte warten Sie, während wir die Daten verarbeiten</div>
        </div>
      </div>
    )
  }
