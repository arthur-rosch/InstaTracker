        ...
        <div className="max-w-sm mx-auto text-center">
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="text-sm font-bold">
              ZEITLICH BEGRENZTES ANGEBOT: {String(timeLeft.hours).padStart(2, '0')}:{String(timeLeft.minutes).padStart(2, '0')}:{String(timeLeft.seconds).padStart(2, '0')}
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-lg mx-auto text-center space-y-6">
          ...
          <div className="space-y-3">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight">
              Exklusive <br />
              <span className="instagram-gradient-text">BLACKLIST</span>
            </h1>
            <p className="text-lg text-purple-400 font-semibold">
              ERWEITERTE ÜBERWACHUNGSSYSTEM
            </p>
          </div>
            ...
            <div className="relative z-10 space-y-4">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-300 text-sm">
                  Erhalten Sie Benachrichtigungen, wenn die überwachte Person mit bestimmten Profilen interagiert!
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-white font-semibold text-sm mb-1">Personalisierte Liste verbotener Profile</h3>
                    <p className="text-gray-300 text-xs">
                      Fügen Sie spezifische Kontakte hinzu, die Sie mit besonderer Aufmerksamkeit überwachen möchten und erfahren Sie sofort, wenn es eine Interaktion gibt.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-white font-semibold text-sm mb-1">Sofortige Benachrichtigungen</h3>
                    <p className="text-gray-300 text-xs">
                      Erhalten Sie Echtzeit-Benachrichtigungen, wenn die überwachte Person jemanden von der Blacklist liked, kommentiert oder folgt.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-white font-semibold text-sm mb-1">Detaillierte Interaktionsaufzeichnung</h3>
                    <p className="text-gray-300 text-xs">
                      Führen Sie eine vollständige Historie mit der genauen Zeit jeder Interaktion. Bewahren Sie eine Beweisdatei aller Aktivitäten zur Konsultation bei Bedarf auf.
                    </p>
                  </div>
                </div>
              </div>
