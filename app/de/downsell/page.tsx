      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-red-600 text-white py-3 px-4">
        <div className="container mx-auto flex items-center justify-center space-x-4">
          <span className="font-semibold text-sm md:text-base">
            🎉 HERZLICHEN GLÜCKWUNSCH! SIE HABEN 50% RABATT GEWONNEN! 🎉
          </span>
        </div>
      </div>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Ihr Platz in der Anwendung <span className="text-purple-400 font-bold">Instagram Dossier</span> ist mit Schutz garantiert.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                Ohne diesen Schutz kann Ihre Anwendung mit Sicherheitsbeschränkungen funktionieren und Ihre Daten könnten gefährdet sein. Aktivieren Sie jetzt den Serverschutz.
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Vollständiger Schutz Ihrer Informationen und Privatsphäre.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    24/7-Überwachung und automatische Sicherung aktiviert.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                Aktivieren Sie jetzt den Schutz und sichern Sie Ihren Zugang!
              </h3>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-6 border-2 border-red-500">
              ...
              <p className="text-white text-sm font-bold mt-3">
                VERLIEREN SIE NICHT IHREN SCHUTZ!
              </p>
            ...
            <div className="mt-8">
              ...
              >
                🔒 SCHUTZ AKTIVIEREN<br />MIT 50% RABATT
              </Button>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">Warum brauche ich diesen Schutz?</p>
