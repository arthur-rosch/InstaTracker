  ...
  return (
    <section className="space-y-6 pt-6">
      <div className="text-center">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">Analyse abgeschlossen!</h2>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
          ...
          <div className="flex items-center justify-center mb-4">
            <p className="text-white text-lg font-medium">Stalker der letzten Woche identifiziert</p>
          </div>
        </div>
        ...
        <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-6 shadow-xl">
          <div className="flex items-start space-x-4 mb-4">
            ...
            <div>
              <h3 className="text-red-400 font-bold text-lg">Super-Stalker gefunden!</h3>
          ...
          <div className="grid gap-3">
            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                Dieser Super-Stalker besuchte das Profil von {profileData?.name || username} 11 Tage hintereinander
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                {profileData?.name || username} führte 3 Videoanrufe durch und löschte die Unterhaltung mit diesem Stalker
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                Einige Unterhaltungen enthalten sexuelle Inhalte, die wir hier nicht zeigen können
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                {profileData?.name || username} fügte nur diesen Stalker zu engen Freunden hinzu
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                Die Interaktion dieses Stalkers übertrifft den zweiten Platz um das 11-fache
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-4 shadow-xl">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-red-400 font-bold text-lg">Verlassen Sie diese Seite nicht.</h3>
              <p className="text-white text-sm mt-1">Wir erlauben nur EINE ANSICHT pro Gerät.</p>
            </div>
          </div>
        </div>
      </div>
