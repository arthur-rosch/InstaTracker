  ...
  if (typeof window !== 'undefined') {
    ...
    if (stored) {
      try {
        ...
        return {
          name: data.profile?.fullName || "Unbekannter Benutzer",
...
const analysisTopics = [
  { label: "Profilinformationen", completed: false, threshold: 20 },
  { label: "Story-Interaktionen", completed: false, threshold: 30 },
  { label: "Direktnachrichten", completed: false, threshold: 40 },
  { label: "Liste enger Freunde", completed: false, threshold: 50 },
  { label: "Profilbesucher", completed: false, threshold: 60 },
  { label: "Gelöschte Inhalte", completed: false, threshold: 70 },
  { label: "Versteckte Verbindungen", completed: false, threshold: 80 },
  { label: "Sicherheitsanalyse", completed: false, threshold: 90 },
]
...
const reviews = [
  {
    ...
    time: "vor 2 Tagen",
    rating: 5,
    text: "Ich dachte, meine Ex-Freundin wäre weitergezogen... 😤 Sie sieht immer noch alle meine Stories. Diese App hat die Wahrheit enthüllt, die ich wissen musste!",
    verified: true,
  ...
  },
  {
    ...
    time: "vor 1 Tag",
    rating: 5,
    text: "Endlich habe ich herausgefunden, wer täglich mein Profil überprüft! Diese App ist unglaublich und absolut lohnenswert! 🔥",
    verified: true,
      ...
      <div className={`relative z-10 px-4 space-y-8 ${showButton ? "pb-24" : "pb-8"}`}>
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-base font-semibold text-white">Instagram-Informationen sammeln</h2>
            <p className="text-gray-300 text-sm">Bitte haben Sie Geduld, während wir Millionen von Datensätzen durchsuchen</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
            ...
            <p className="text-gray-300 text-sm text-center">
              Ihr Suchverlauf ist sicher und privat. Der Besitzer des Instagram-Profils wird nicht über Ihre
              Suche benachrichtigt.
            </p>
          </div>

          {/* Analysis Topics - 2x2 Grid */}
          <div className="space-y-4">
            <h3 className="text-white font-semibold">Daten sammeln...</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-2 mb-2">
                <span className="text-2xl font-bold text-white">Ausgezeichnet</span>
              ...
              <p className="text-gray-300">
                <span className="font-bold text-white">4.75</span> basierend auf{" "}
                <span className="font-bold text-white">338</span> Bewertungen
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-300 text-sm">Verifizierter Kunde</span>
                </div>
          ...
          <div className="space-y-6">
            <p className="text-gray-300 font-medium text-center text-sm">INSTACHECK WURDE VORGESTELLT IN</p>
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="text-white text-lg">Analyse wird geladen...</div>
        <div className="text-gray-400 text-sm mt-2">Bitte warten Sie, während wir Ihre Profilanalyse vorbereiten</div>
      </div>
    </div>
  )
}
