        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl mb-6">
            ...
            <div className="text-center mb-6">
              ...
              {!profileData && (
                <div>
                  <h2 className="text-white text-2xl font-bold mb-2">Vollständige Analyse</h2>
            ...
            <div className="bg-pink-500/10 border border-pink-500/20 rounded-2xl p-4 mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-pink-200 font-medium text-sm mb-1">Vollständigen Bericht freischalten</div>
                  <div className="text-pink-300/80 text-xs">Erhalten Sie Echtzeit-Zugang zu allen Funktionen:</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Stalker-Verfolgung</h3>
                  <p className="text-gray-400 text-xs">Entdecken Sie, wer Ihr Profil heimlich besucht</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Screenshot-Benachrichtigungen</h3>
                  <p className="text-gray-400 text-xs">Wissen Sie, wann jemand Ihre Inhalte aufnimmt</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Story-Betrachter</h3>
                  <p className="text-gray-400 text-xs">Sehen Sie, wer Ihre Stories wiederholt ansieht</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Erwähnungs-Verfolgung</h3>
                  <p className="text-gray-400 text-xs">Verfolgen Sie, wer Sie in privaten Chats erwähnt</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-4 mb-6 text-center">
              ...
              <h3 className="text-white text-lg font-bold mb-1">+235,742 Profile</h3>
              <p className="text-gray-400 text-xs">Treten Sie der Gemeinschaft bei, die die Wahrheit entdeckt hat</p>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-white/5 rounded-2xl p-4">
                ...
                <p className="text-gray-300 text-xs mb-3 leading-relaxed">
                  "Ich habe herausgefunden, wer mein Profil gestalkt hat! Jeden Cent wert!"
                </p>
              ...
              <div className="bg-white/5 rounded-2xl p-4">
                ...
                <p className="text-gray-300 text-xs mb-3 leading-relaxed">
                  "Unglaublich! Jetzt weiß ich, wer meine Stories wiederholt ansieht."
                </p>
                <div className="flex space-x-1">
                  <span className="text-yellow-400 text-sm">★</span>
                  <span className="text-yellow-400 text-sm">★</span>
            ...
            <div className="border-t border-white/10 pt-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-white text-lg font-bold">Premium-Zugang</h3>
              ...
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-green-400 text-sm font-medium">100% sichere Zahlung</span>
              </div>
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white text-sm">Lebenslanger Zugang</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                  <span className="text-white text-sm">Echtzeit-Updates</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                  <span className="text-white text-sm">Bonus: Zugang zu engen Freunden</span>
                </div>
              </div>
              ...
              >
                Vollständigen Bericht jetzt erhalten
              </Button>
            </div>
          </div>
        </div>
