      ...
      <div className="relative z-10">
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Screenshots, Aufnahmen ansehen...</p>
              </div>
            </div>
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-purple-400 text-sm">Wischen, um wiederhergestellte Gespräche zu sehen</p>
            <p className="text-gray-400 text-xs">Jetzt aktualisiert</p>
          </div>
        </div>
      </div>
    </div>
