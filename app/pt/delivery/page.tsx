  ...
  const services = [
    {
      id: "instagram",
      name: "Instagram",
      description: "Ver DMs, Stalkers, Redirecionamentos...",
    ...
    },
    {
      id: "whatsapp",
      name: "WhatsApp",
      description: "Ver conversas, chamadas...",
    ...
    },
    {
      id: "facebook",
      name: "Facebook",
      description: "Acessar Messenger, recuperar conversas...",
    ...
    },
    {
      id: "location",
      name: "Localização",
      description: "Exibir a localização da pessoa monitorada em tempo real.",
      icon: MapPin,
      status: "Inativo"
    },
    {
      id: "social",
      name: "Redes Sociais",
      description: "Exibir todas as redes sociais dessa pessoa. Ex: Tinder",
    ...
    },
    {
      id: "camera",
      name: "Câmera",
      description: "Obter acesso à câmera e microfone do telefone...",
      icon: Camera,
      status: "Inativo"
    },
    {
      id: "gallery",
      name: "Galeria",
      description: "Ver galeria de fotos, álbuns secretos, fotos excluídas...",
    ...
    },
    {
      id: "adult",
      name: "+18",
      description: "Acessar conteúdo adulto e vídeos privados...",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 mt-12 mx-4">
            ...
            <div className="inline-block bg-white/5 backdrop-blur-xl border border-purple-400/30 rounded-2xl px-6 py-4 mb-6 shadow-2xl">
              ...
              <div className="relative z-10 flex items-center space-x-3">
                ...
                <div className="text-left">
                  <h2 className="text-white font-bold text-lg">Bem-vindo!</h2>
                  <p className="text-purple-300 text-sm">Você tem 1 relatório disponível esta semana.</p>
                </div>
            ...
            <p className="text-gray-300 text-lg mb-8">disponíveis para você</p>
          </div>
            ...
            {services.map((service) => {
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    if (service.id === 'instagram' && service.status === 'Ativo') {
                      router.push('/pt/delivery-insta')
                    } else {
