        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl mb-6">
            ...
            <div className="text-center mb-6">
              ...
              {!profileData && (
                <div>
                  <h2 className="text-white text-2xl font-bold mb-2">Análise Completa</h2>
            ...
            <div className="bg-pink-500/10 border border-pink-500/20 rounded-2xl p-4 mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-pink-200 font-medium text-sm mb-1">Desbloquear Relatório Completo</div>
                  <div className="text-pink-300/80 text-xs">Obtenha acesso em tempo real a todas as funcionalidades:</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Rastreamento de Stalkers</h3>
                  <p className="text-gray-400 text-xs">Descubra quem visita seu perfil secretamente</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Notificações de Captura de Tela</h3>
                  <p className="text-gray-400 text-xs">Saiba quando alguém captura seu conteúdo</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Visualizador de Stories</h3>
                  <p className="text-gray-400 text-xs">Veja quem assiste suas Stories repetidamente</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Rastreamento de Menções</h3>
                  <p className="text-gray-400 text-xs">Rastreie quem te menciona em chats privados</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-4 mb-6 text-center">
              ...
              <h3 className="text-white text-lg font-bold mb-1">+235.742 Perfis</h3>
              <p className="text-gray-400 text-xs">Junte-se à comunidade que descobriu a verdade</p>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-white/5 rounded-2xl p-4">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <p className="text-gray-400 text-xs">2min atrás</p>
                  </div>
                </div>
              ...
              <div className="bg-white/5 rounded-2xl p-4">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs">5min atrás</p>
                  </div>
                </div>
                <p className="text-gray-300 text-xs mb-3 leading-relaxed">
                  "Incrível! Agora sei quem está assistindo minhas Stories repetidamente."
                </p>
                <div className="flex space-x-1">
                  <span className="text-yellow-400 text-sm">★</span>
                  <span className="text-yellow-400 text-sm">★</span>
            ...
            <div className="border-t border-white/10 pt-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-white text-lg font-bold">Acesso Premium</h3>
              ...
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-green-400 text-sm font-medium">Pagamento 100% seguro</span>
              </div>
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                  <span className="text-white text-sm">Atualizações em Tempo Real</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                  <span className="text-white text-sm">Suporte 24/7</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                  <span className="text-white text-sm">Bônus: Acesso a Amigos Próximos</span>
                </div>
              </div>
              ...
              >
                Obter Relatório Completo Agora
              </Button>
            </div>
          </div>
        </div>
