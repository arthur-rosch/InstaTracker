      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-red-600 text-white py-3 px-4">
        <div className="container mx-auto flex items-center justify-center space-x-4">
          <span className="font-semibold text-sm md:text-base">
            🎉 PARABÉNS! VOCÊ GANHOU 50% DE DESCONTO! 🎉
          </span>
        </div>
      </div>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white text-lg">
                Garanta a segurança dos seus dados agora
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Seu lugar no aplicativo <span className="text-purple-400 font-bold">Instagram Dossier</span> está garantido com proteção.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                Sem essa proteção, seu aplicativo pode funcionar com restrições de segurança e seus dados podem estar em risco. Ative a proteção do servidor agora.
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Proteção completa das suas informações e privacidade.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Monitoramento 24/7 e backup automático ativados.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                Ative a proteção agora e garanta seu acesso!
              </h3>
            </div>
            ...
            <div className="mt-8">
              ...
              >
                🔒 ATIVAR PROTEÇÃO<br />COM 50% DE DESCONTO
              </Button>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">Por que preciso dessa proteção?</p>
