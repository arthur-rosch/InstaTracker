        ...
        <div className="max-w-lg mx-auto text-center space-y-6">
          ...
          <div className="space-y-3">
            <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight">
              Acesso à Câmera <br />
              <span className="instagram-gradient-text">Oculta</span>
            </h1>
            <p className="text-lg text-purple-400 font-semibold">
              100% ANÔNIMO E SEGURO
            </p>
            <p className="text-gray-300 leading-relaxed">
              Acesse a câmera de qualquer telefone em tempo real
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-2xl hover:bg-white/10 transition-all duration-300">
            ...
            <div className="relative z-10">
              <p className="text-gray-300 text-sm leading-relaxed">
                Monitore remotamente a câmera de qualquer número de telefone sem que a pessoa saiba. Transmissão ao vivo, sem necessidade de instalação de aplicativo, 100% invisível.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-left">
              <label className="block text-xs font-medium text-gray-300 mb-2">
                Número de Telefone a Monitorar
              </label>
              <Input
                type="tel"
                value={phoneNumber}
            ...
            <div className="text-left">
              ...
              >
                ...
                <option value="both">Ambas as Câmeras</option>
              </select>
            </div>
            ...
            <div className="text-left">
              ...
              <select
                ...
                className="w-full h-12 text-base border-2 border-gray-800 bg-gray-900 text-white focus:border-purple-500 rounded-2xl px-4 appearance-none"
              >
                <option value="premium">Acesso Premium (Vídeo e Áudio)</option>
                <option value="basic">Acesso Básico (Somente Vídeo)</option>
              </select>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 max-w-2xl mx-auto mt-8">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <div className="relative z-10">
                <h3 className="text-lg font-bold text-white mb-2">100% Anônimo</h3>
                <p className="text-gray-300 text-sm">
                  Sua identidade permanece completamente oculta. A pessoa não saberá que está sendo monitorada.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <div className="relative z-10">
                <h3 className="text-lg font-bold text-white mb-2">Qualquer Telefone</h3>
                <p className="text-gray-300 text-sm">
                  Funciona com qualquer número de telefone, independentemente da operadora ou modelo do aparelho.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Trust indicators */}
          <p className="text-xs text-gray-400 pt-4">100% Anônimo • Resultados Instantâneos • Não é necessário registro</p>
        </div>
      </div>
    </section>
  )
