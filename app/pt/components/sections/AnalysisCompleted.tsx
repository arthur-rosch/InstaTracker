  ...
  return (
    <section className="space-y-6 pt-6">
      <div className="text-center">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">Análise Concluída!</h2>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
          ...
          <div className="flex items-center justify-center mb-4">
            <p className="text-white text-lg font-medium">Stalkers da última semana identificados</p>
          </div>
        </div>
          ...
          <div className="grid gap-3">
            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                Este Super-Stalker visitou o perfil de {profileData?.name || username} por 11 dias consecutivos
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                {profileData?.name || username} fez 3 chamadas de vídeo e excluiu a conversa com este Stalker
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                Algumas conversas contêm conteúdo sexual que não podemos exibir aqui
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                {profileData?.name || username} adicionou apenas este Stalker aos amigos próximos
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                A interação deste Stalker supera o segundo colocado em 11 vezes
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-4 shadow-xl">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-red-400 font-bold text-lg">Não saia desta página.</h3>
              <p className="text-white text-sm mt-1">Permitimos apenas UMA VISUALIZAÇÃO por dispositivo.</p>
            </div>
          </div>
        </div>
      </div>
