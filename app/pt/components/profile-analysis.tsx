  ...
  if (typeof window !== 'undefined') {
    ...
    if (stored) {
      try {
        ...
        return {
          name: data.profile?.fullName || "Usuário Desconhecido",
...
const analysisTopics = [
  { label: "Informações do Perfil", completed: false, threshold: 20 },
  { label: "Interações de Stories", completed: false, threshold: 30 },
  { label: "Mensagens Diretas", completed: false, threshold: 40 },
  { label: "Lista de Amigos Próximos", completed: false, threshold: 50 },
  { label: "Visitantes do Perfil", completed: false, threshold: 60 },
  { label: "Conteúdo Excluído", completed: false, threshold: 70 },
  { label: "Conexões Ocultas", completed: false, threshold: 80 },
  { label: "Análise de Segurança", completed: false, threshold: 90 },
]
...
const reviews = [
  {
    ...
    time: "vor 2 Tagen",
    rating: 5,
    text: "Eu pensei que minha ex-namorada tinha superado... 😤 Ela ainda vê todas as minhas Stories. Este aplicativo revelou a verdade que eu precisava saber!",
    verified: true,
  ...
  },
  {
    ...
    time: "há 1 dia",
    rating: 5,
    text: "Finalmente descobri quem verifica meu perfil diariamente! Este aplicativo é incrível e totalmente vale a pena! 🔥",
    verified: true,
...
function ProfileAnalysisContent() {
  ...
  const handleGenerateReport = () => {
    router.push(`/pt/report?username=${username}`)
  }
      ...
      <div className={`relative z-10 px-4 space-y-8 ${showButton ? "pb-24" : "pb-8"}`}>
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-base font-semibold text-white">Coletando informações do Instagram</h2>
          <p className="text-gray-300 text-sm">Por favor, seja paciente enquanto pesquisamos milhões de registros de dados</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
            ...
            <p className="text-gray-300 text-sm text-center">
              Seu histórico de pesquisa é seguro e privado. O proprietário do perfil do Instagram não será notificado sobre sua
              pesquisa.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-white font-semibold">Coletando dados...</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-2 mb-2">
                <span className="text-2xl font-bold text-white">Excelente</span>
              ...
              <p className="text-gray-300">
                <span className="font-bold text-white">4.75</span> baseado em{" "}
                <span className="font-bold text-white">338</span> avaliações
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-300 text-sm">Cliente Verificado</span>
                </div>
          ...
          <div className="space-y-6">
            <p className="text-gray-300 font-medium text-center text-sm">INSTACHECK FOI APRESENTADO EM</p>
      ...
      {showButton && (
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-black/80 backdrop-blur-xl border-t border-white/10 z-50">
          <div className="max-w-md mx-auto">
            ...
            >
              Acessar Instagram em Tempo Real
            </button>
          </div>
        </div>
      )}
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="text-white text-lg">Análise sendo carregada...</div>
        <div className="text-gray-400 text-sm mt-2">Por favor, aguarde enquanto preparamos sua análise de perfil</div>
      </div>
    </div>
  )
}
