...
import { AnalysisCompleted } from "./sections/AnalysisCompleted"
import { WeeklyVisits } from "./sections/WeeklyVisits"
import { PrintsRecovered } from "./sections/PrintsRecovered"
import { MainActivities } from "./sections/MainActivities"
import { InteractionsDetected } from "./sections/InteractionsDetected"
import { TopObservers } from "./sections/TopObservers"
      ...
      <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="text-gray-400 text-sm max-w-xs mx-auto">Por favor, aguarde enquanto analisamos o perfil e coletamos todos os dados necessários</div>
          </div>
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 p-4 pt-8 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-lg font-semibold text-white">Instagram em Tempo Real</h1>
          ...
          <div className="w-full bg-white10 backdrop-blur-md border border-white/20 rounded-2xl p-4 shadow-2xl">
            <div className="flex items-center space-x-3 mb-3">
              <p className="text-white text-sm font-medium text-center">
                Por motivos de privacidade, só podemos manter seu relatório disponível para compra por 10 minutos
              </p>
            </div>
            <button
