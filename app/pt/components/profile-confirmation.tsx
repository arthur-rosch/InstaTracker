...
function ProfileConfirmationContent() {
  ...
  const handleContinue = async () => {
    ...
    router.push(`/pt/results?username=${username}`)
  }
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-white text-center">
          <h2 className="text-xl mb-4">Nenhum nome de usuário fornecido</h2>
        ...
        <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto space-y-6">
              ...
              <>
                ...
                <div className="flex justify-between items-center py-3 sm:py-4 border-t border-white/10">
                  ...
                  <div className="text-center flex-1">
                    ...
                    <div className="text-xs sm:text-sm text-gray-400">Publicações</div>
                  </div>
                </div>
              </>
            )}
          ...
          {profile && !profileLoading && (
            <div className="text-center">
              <h2 className="text-sm sm:text-base md:text-lg text-white font-semibold">Este é o perfil correto do Instagram?</h2>
            </div>
          )}
