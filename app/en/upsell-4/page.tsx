        ...
        <div className="max-w-sm mx-auto text-center">
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="text-sm font-bold">
              LIMITED TIME OFFER: {String(timeLeft.hours).padStart(2, '0')}:{String(timeLeft.minutes).padStart(2, '0')}:{String(timeLeft.seconds).padStart(2, '0')}
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-lg mx-auto text-center space-y-6">
          ...
          <div className="space-y-3">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight">
              Black List <br />
              <span className="instagram-gradient-text">EXCLUSIVE</span>
            </h1>
            ...
            <div className="relative z-10 space-y-4">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-300 text-sm">
                  Receive alerts if the monitored person interacts with certain profiles!
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-white font-semibold text-sm mb-1">Custom Prohibited Profile List</h3>
                    <p className="text-gray-300 text-xs">
                      Add specific contacts you want to monitor with special attention and know instantly when there's any interaction.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-white font-semibold text-sm mb-1">Instant Notifications</h3>
                    <p className="text-gray-300 text-xs">
                      Receive real-time alerts when the monitored person likes, comments, or follows someone from the blacklist.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-white font-semibold text-sm mb-1">Detailed Interaction Log</h3>
                    <p className="text-gray-300 text-xs">
                      Keep a complete history with exact time of each interaction. Maintain an evidence file of all activities for consultation when needed.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            ACTIVATE BLACK LIST PROTECTION
          </Button>
