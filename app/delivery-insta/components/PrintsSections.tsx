...
export default function PrintsSection({ isActive, followers }: PrintsSectionProps) {
  ...
  const generatePrints = (followers: Follower[]) => {
    const messageTemplates = [
      [
        { text: "what are you doing this weekend?", time: "14:32", isRead: true },
        { text: "Why? Do you miss me?😏", time: "14:35", isRead: true, sender: "me" },
        { text: "HAHA a little 🙈", time: "14:36", isRead: false }
      ],
      [
        { text: "Did you see my story yesterday?", time: "22:15", isRead: true },
        { text: "Yes, I did... you looked beautiful 🔥", time: "22:18", isRead: true, sender: "me" },
        { text: "Thank you, love ❤️ I miss you", time: "22:20", isRead: false }
      ],
      [
        { text: "Hi handsome 😘", time: "19:45", isRead: true },
        { text: "Hi princess, how was your day?", time: "19:50", isRead: true, sender: "me" },
        { text: "Better now that you replied 💕", time: "19:52", isRead: false }
      ],
      [
        { text: "I miss you...", time: "23:30", isRead: true },
        { text: "Me too... when can we see each other?", time: "23:33", isRead: true, sender: "me" },
        { text: "Tomorrow? My parents won't be home 😏", time: "23:35", isRead: false }
      ]
    ];
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Recovered Prints</h3>
                <p className="text-gray-400 text-sm">Private conversations</p>
              </div>
            </div>
          ...
          <div className="text-center space-y-2">
            <p className="text-white font-bold text-2xl">{prints.length} Prints</p>
            <p className="text-purple-400 text-sm">Swipe to view recovered conversations</p>
