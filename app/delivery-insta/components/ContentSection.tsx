        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Content</h3>
                <p className="text-gray-300 text-sm">See Stories, Posts, Shares...</p>
              </div>
            </div>
          ...
          <div className="space-y-6 mt-6">
            <div className="space-y-4">
              <h4 className="text-white font-semibold text-base">Content type most shared</h4>
            ...
            <div className="space-y-4">
              <h4 className="text-white font-semibold text-base">Content shared this week</h4>
              <div className="bg-white/5 rounded-lg p-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-300 text-sm">Average per day</span>
