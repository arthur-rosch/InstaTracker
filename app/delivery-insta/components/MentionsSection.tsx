        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Mentions Estimate</h3>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center space-y-2">
              <p className="text-white text-sm md:text-base font-medium">
                Unlock the Prints Center to view messages that
              </p>
              <p className="text-white text-sm md:text-base font-medium">
                mentioned your name.
              </p>
            ...
            {/* Status */}
            <div className="text-center">
              <p className="text-gray-400 text-sm">Updated now</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="bg-black/95 border border-white/20 text-white w-[95vw] max-w-lg max-h-[85vh] overflow-hidden">
          <DialogHeader className="flex flex-row items-center justify-between pb-4">
            <DialogTitle className="text-lg md:text-xl font-bold">People who mentioned you ({displayFollowers.length})</DialogTitle>
            <Button
              variant="ghost"
              size="sm"
