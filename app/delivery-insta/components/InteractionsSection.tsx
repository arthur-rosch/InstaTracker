      ...
      <div className="relative z-10">
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">See DMs, Stalkers, Forwards...</p>
              </div>
            </div>
          ...
          <div className="flex flex-col space-y-6 mt-6">
            ...
            <div className="flex justify-center">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white text-base font-medium">85% Viewed stories</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-4 h-4 bg-gray-600 rounded-full"></div>
                  <span className="text-gray-400 text-base">15% Not viewed</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <p className="text-white font-semibold text-base mb-4">Shared your profile this week</p>
              <div className="flex items-center justify-center space-x-3">
                <span className="text-purple-400 font-bold text-2xl">11</span>
                <span className="text-gray-400 text-base">People</span>
                <div className="text-purple-400">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                  </svg>
