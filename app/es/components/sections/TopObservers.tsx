...
const mockTopObservers = [
  { username: "@g********", action: "42 publicaciones guardadas" },
  { username: "@d********", action: "65 vistas del perfil" },
  { username: "@k********", action: "52 historias vistas" }
]
  ...
  return (
    <section className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-xl font-bold text-white mb-2">Tus principales observadores</h3>
        <p className="text-gray-300">Estos perfiles interactúan más con tu contenido</p>
      </div>
