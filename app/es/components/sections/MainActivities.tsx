...
const mockActivities = [
  { username: "@d******", action: "Eliminó mensajes DM - 12 veces ayer", icon: Lock },
  { username: "@a******", action: "Agregado a amigos cercanos", icon: Users },
  { username: "@o******", action: "Pasó +52m en videollamada con eo.rosch", icon: Clock }
]
  ...
  return (
    <section className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-white mb-2">Principales actividades detectadas esta semana</h2>
      </div>
...
Acceder a Instagram en Tiempo Real
      ...
      <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-4 shadow-xl">
        <div className="flex items-center space-x-3">
          ...
          <p className="text-white">Perfiles fueron restringidos en las historias y publicaciones de {username}</p>
        </div>
      </div>
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
        <div className="mb-4">
          <div className="flex items-center space-x-3 mb-3">
            <div>
              <h3 className="text-white font-bold text-lg">Actividad de Ubicación Detectada</h3>
              <p className="text-gray-300 text-sm">Rastreo de ubicación en tiempo real</p>
            </div>
          </div>
        </div>
