    ...
    <section className="space-y-6">
      <div className="rounded-3xl p-8 text-center">
        ...
        <div className="flex items-center justify-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-white">Amigos Cercanos</h2>
        </div>

        {/* Subtitle */}
        <p className="text-gray-300 text-lg mb-8">
          @{profileData?.name || username} y {displayFollowers.length || 4} otras personas agregaron este perfil a amigos cercanos
        </p>
        ...
        <p className="text-gray-400 text-sm">
          ...y 2 otras personas que no siguen a {username}
        </p>
      </div>
      <div className="pt-4">
        <button
