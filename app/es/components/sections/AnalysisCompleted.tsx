  ...
  return (
    <section className="space-y-6 pt-6">
      <div className="text-center">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">¡Análisis Completado!</h2>
      </div>
      ...
      <div className="space-y-4">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <p className="text-white text-lg font-medium">{followers.length > 0 ? followers.length : 4} perfiles de {userCity} están accediendo a este perfil ahora</p>
            {followersLoading && <span className="text-gray-400 text-sm">Cargando...</span>}
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
          ...
          <div className="flex items-center justify-center mb-4">
            <p className="text-white text-lg font-medium">Acosadores identificados la semana pasada</p>
          </div>
        </div>
        ...
        <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-6 shadow-xl">
          <div className="flex items-start space-x-4 mb-4">
            ...
            <div>
              <h3 className="text-red-400 font-bold text-lg">¡Super Acosador Encontrado!</h3>
              <p className="text-white">¡{profileData?.name || username} tiene un fan en el perfil!</p>
            </div>
          </div>
          ...
          <div className="grid gap-3">
            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                Este Super Acosador visitó el perfil de {profileData?.name || username} durante 11 días consecutivos
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                {profileData?.name || username} hizo 3 videollamadas y eliminó la conversación con este Acosador
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                Algunas conversaciones contienen contenido sexual más allá de lo que podemos mostrar aquí
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                {profileData?.name || username} agregó solo a este Acosador a amigos cercanos
              </p>
            </div>

            <div className="bg-red-800/20 border border-red-600/20 rounded-lg p-3">
              <p className="text-gray-300 text-sm">
                La interacción de este Acosador supera al segundo lugar por 11 veces
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-red-900/20 border border-red-500/30 rounded-2xl p-4 shadow-xl">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-red-400 font-bold text-lg">No abandones esta página.</h3>
              <p className="text-white text-sm mt-1">Solo permitimos UNA VISTA por dispositivo.</p>
            </div>
          </div>
        </div>
      </div>
