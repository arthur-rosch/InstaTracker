...
const mockInteractions = [
  { text: "5 capturas de pantalla de tus historias", icon: Eye },
  { text: "Vio tus historias 13 veces", icon: Eye },
  { text: "Compartió tus historias 13 veces", icon: UserCheck },
  { text: "Guardó 15 de tus publicaciones", icon: Heart }
]
  ...
  return (
    <section className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-white mb-2">Interacciones detectadas</h2>
      </div>
