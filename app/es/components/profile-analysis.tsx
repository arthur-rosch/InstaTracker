  ...
  if (typeof window !== 'undefined') {
    ...
    if (stored) {
      try {
        ...
        return {
          name: data.profile?.fullName || "Usuario Desconocido",
...
const analysisTopics = [
  { label: "Información del Perfil", completed: false, threshold: 20 },
  { label: "Interacciones de Historias", completed: false, threshold: 30 },
  { label: "Mensajes Directos", completed: false, threshold: 40 },
  { label: "Lista de Amigos Cercanos", completed: false, threshold: 50 },
  { label: "Visitantes del Perfil", completed: false, threshold: 60 },
  { label: "Contenido Eliminado", completed: false, threshold: 70 },
  { label: "Conexiones Ocultas", completed: false, threshold: 80 },
  { label: "Análisis de Seguridad", completed: false, threshold: 90 },
]
...
const reviews = [
  {
    ...
    time: "hace 2 días",
    rating: 5,
    text: "Pensé que mi ex-novia había seguido adelante... 😤 Todavía ve todas mis historias. ¡Esta app reveló la verdad que necesitaba saber!",
    verified: true,
  ...
  },
  {
    ...
    time: "hace 1 día",
    rating: 5,
    text: "¡Finalmente descubrí quién ha estado revisando mi perfil diariamente! ¡Esta app es increíble y totalmente vale la pena! 🔥",
    verified: true,
...
function ProfileAnalysisContent() {
  ...
  const handleGenerateReport = () => {
    router.push(`/es/report?username=${username}`)
  }
      ...
      <div className={`relative z-10 px-4 space-y-8 ${showButton ? "pb-24" : "pb-8"}`}>
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-base font-semibold text-white">Recopilando información de Instagram</h2>
            <p className="text-gray-300 text-sm">Por favor ten paciencia mientras buscamos entre millones de registros</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl">
            ...
            <p className="text-gray-300 text-sm text-center">
              Tu historial de búsqueda es seguro y privado. El propietario del perfil de Instagram no será notificado sobre tu
              búsqueda.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-white font-semibold">Recopilando Datos...</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                <span className="font-bold text-white">4.75</span> basado en{" "}
                <span className="font-bold text-white">338</span> reseñas
              </p>
            </div>
          ...
          <div className="space-y-6">
            <p className="text-gray-300 font-medium text-center text-sm">INSTACHECK FUE DESTACADO EN</p>
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="text-gray-400 text-sm mt-2">Por favor espera mientras preparamos tu análisis de perfil</div>
      </div>
    </div>
  )
}
