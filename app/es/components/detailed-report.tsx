      ...
      <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          <div className="space-y-2">
            <div className="text-white text-xl font-semibold">Recopilando información...</div>
            <div className="text-gray-400 text-sm max-w-xs mx-auto">Por favor espera mientras analizamos el perfil y recopilamos todos los datos necesarios</div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              <span className="text-gray-300 text-sm">Cargando seguidores</span>
            </div>
            <div className="flex items-center justify-center space-x-2">
              <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse delay-600"></div>
              <span className="text-gray-300 text-sm">Preparando reporte</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 p-4 pt-8 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-lg font-semibold text-white">Instagram en tiempo real</h1>
          ...
          <div className="w-full bg-white10 backdrop-blur-md border border-white/20 rounded-2xl p-4 shadow-2xl">
            <div className="flex items-center space-x-3 mb-3">
              <p className="text-white text-sm font-medium text-center">
                Por razones de privacidad, solo podemos mantener tu reporte disponible para compra por 10 minutos
              </p>
            </div>
            <button
