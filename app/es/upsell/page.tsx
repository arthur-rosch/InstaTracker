      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-red-600 text-white py-3 px-4">
        <div className="container mx-auto flex items-center justify-center space-x-4">
          <span className="font-semibold text-sm md:text-base">
            ¡NO ABANDONES ESTA PÁGINA, PUEDE CAUSAR PÉRDIDA DE DATOS!
          </span>
        </div>
      </div>
      ...
      <section className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex flex-col justify-center relative overflow-hidden pt-16 pb-24">
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-md">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <h1 className="text-white text-lg font-semibold">Actualizar</h1>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white text-lg">
                Casi accediendo a la aplicación
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Tu lugar en la aplicación <span className="text-purple-400 font-bold">Instagram Dossier</span> está garantizado.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                Debido al gran volumen de datos comprometedores eliminados encontrados en Instagram, necesitamos actualizar el paquete de firewall para revelar todos los datos comprometedores. Si eliges "perder datos", tu investigación puede perderse para siempre.
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Garantiza la revelación de todos tus datos y descubre la verdad de una vez por todas.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    ¿Confías lo suficiente como para ignorar la verdad?
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                ¡Libéralo ahora y aprovecha al máximo tu aplicación!
              </h3>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-6 border-2 border-red-500">
              ...
              <p className="text-white text-sm font-semibold mb-3">LA OFERTA EXPIRA EN</p>
            ...
            <div className="mt-8">
              ...
              >
                🔥 HAZ CLIC AQUÍ PARA ACCEDER<br />A TODOS LOS DATOS
              </Button>
            </div>

            {/* FAQ Section */}
            <div className="mt-12">
              <h3 className="text-purple-400 text-xl font-bold mb-4">PREGUNTAS FRECUENTES</h3>
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">¿Por qué necesito pagar esta tarifa?</p>
