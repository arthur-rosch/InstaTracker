  ...
  const services = [
    {
      id: "instagram",
      name: "Instagram",
      description: "Ver DMs, Stalkers, Reenvíos...",
    ...
    },
    {
      id: "whatsapp",
      name: "WhatsApp",
      description: "Ver Conversaciones, Llamadas...",
    ...
    },
    {
      id: "facebook",
      name: "Facebook",
      description: "Acceder a Messenger, Obtener conversaciones...",
    ...
    },
    {
      id: "location",
      name: "Ubicación",
      description: "Ver la ubicación de la persona espiada en tiempo real.",
      icon: MapPin,
      status: "Inactivo"
    },
    {
      id: "social",
      name: "Redes Sociales",
      description: "Ver todas las redes sociales que tiene esa persona. Ej: Tinder",
    ...
    },
    {
      id: "camera",
      name: "Cámara",
      description: "Obtener acceso a la cámara y micrófono del teléfono...",
      icon: Camera,
      status: "Inactivo"
    },
    {
      id: "gallery",
      name: "Galería",
      description: "Ver la galería de fotos, álbumes secretos, fotos eliminadas...",
    ...
    },
    {
      id: "adult",
      name: "+18",
      description: "Acceder a contenido adulto y videos privados...",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 mt-12 mx-4">
            ...
            <div className="inline-block bg-white/5 backdrop-blur-xl border border-purple-400/30 rounded-2xl px-6 py-4 mb-6 shadow-2xl">
              ...
              <div className="relative z-10 flex items-center space-x-3">
                ...
                <div className="text-left">
                  <h2 className="text-white font-bold text-lg">¡Bienvenido!</h2>
                  <p className="text-purple-300 text-sm">Tienes 1 reporte disponible esta semana.</p>
                </div>
            ...
            <p className="text-gray-300 text-lg mb-8">disponibles para ti</p>
          </div>
            ...
            {services.map((service) => {
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    if (service.id === 'instagram' && service.status === 'Activo') {
                      router.push('/es/delivery-insta')
                    } else {
