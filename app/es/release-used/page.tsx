...
function ReleaseUsedContent() {
  ...
  const handleViewExistingReport = () => {
    if (username) {
      router.push(`/es/results?username=${username.replace('@', '')}`)
    }
  }
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl mb-6">
            ...
            <div className="text-center mb-6">
              ...
              {!profileData && (
                <div>
                  <h2 className="text-white text-2xl font-bold mb-2">Análisis Completo</h2>
            ...
            <div className="bg-pink-500/10 border border-pink-500/20 rounded-2xl p-4 mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-pink-200 font-medium text-sm mb-1">Desbloquear Reporte Completo</div>
                  <div className="text-pink-300/80 text-xs">Obtén acceso en tiempo real a todas las funciones:</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Rastreo de Acosadores</h3>
                  <p className="text-gray-400 text-xs">Descubre quién visita tu perfil en secreto</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Alertas de Capturas</h3>
                  <p className="text-gray-400 text-xs">Sabe cuándo alguien captura tu contenido</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Visualizadores de Historias</h3>
                  <p className="text-gray-400 text-xs">Ve quién mira tus historias repetidamente</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-sm mb-1">Rastreo de Menciones</h3>
                  <p className="text-gray-400 text-xs">Rastrea quién te menciona en chats privados</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-4 mb-6 text-center">
              ...
              <h3 className="text-white text-lg font-bold mb-1">+235,742 Perfiles</h3>
              <p className="text-gray-400 text-xs">Únete a la comunidad que descubrió la verdad</p>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-white/5 rounded-2xl p-4">
                ...
                <p className="text-gray-300 text-xs mb-3 leading-relaxed">
                  "¡Descubrí quién estaba acosando mi perfil! ¡Vale cada centavo!"
                </p>
              ...
              <div className="bg-white/5 rounded-2xl p-4">
                ...
                <p className="text-gray-300 text-xs mb-3 leading-relaxed">
                  "¡Increíble! Ahora sé quién ve mis historias repetidamente."
                </p>
                <div className="flex space-x-1">
                  <span className="text-yellow-400 text-sm">★</span>
                  <span className="text-yellow-400 text-sm">★</span>
            ...
            <div className="border-t border-white/10 pt-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-white text-lg font-bold">Acceso Premium</h3>
              ...
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-green-400 text-sm font-medium">100% pago seguro</span>
              </div>
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white text-sm">Acceso de por vida</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                  <span className="text-white text-sm">Actualizaciones en tiempo real</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                  <span className="text-white text-sm">Bonus: Acceso a Amigos Cercanos</span>
                </div>
              </div>
              ...
              >
                Obtener Reporte Completo Ahora
              </Button>
            </div>
          </div>
        </div>
