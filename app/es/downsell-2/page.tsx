      ...
      <section className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex flex-col justify-center relative overflow-hidden pt-16 pb-24">
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-md">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <h1 className="text-white text-lg font-semibold">Oferta Final</h1>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Obtén acceso básico a la aplicación <span className="text-purple-400 font-bold">Instagram Dossier</span> con funciones esenciales.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                Esta es tu última oportunidad de obtener acceso a la aplicación Instagram Dossier a un precio con descuento. ¡No te pierdas esta oportunidad final!
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Funciones esenciales de seguimiento para la actividad de Instagram.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Reportes básicos y soporte estándar por correo electrónico.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                ¡Obtén acceso básico ahora con 70% de descuento!
              </h3>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-6 border-2 border-red-500">
              <div className="flex items-center justify-center space-x-2 mb-2">
                <span className="text-white text-sm font-semibold">🚨 CUENTA REGRESIVA FINAL</span>
              </div>
              ...
              <p className="text-white text-sm font-bold mt-3">
                ÚLTIMA OPORTUNIDAD - ¡NO TE LA PIERDAS!
              </p>
            ...
            <div className="mt-8">
              ...
              >
                📱 OBTENER ACCESO BÁSICO<br />CON 70% DE DESCUENTO
              </Button>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">¿Qué incluye el acceso básico?</p>
