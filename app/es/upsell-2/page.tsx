...
export default function Upsell2Page() {
  ...
  const compromisingMessages1: ChatMessage[] = [
    {
      id: 1,
      content: "Oye, ¿estás libre esta noche? 😏",
      type: 'received',
      time: '11:30 PM'
    },
    {
      id: 2,
      content: "Sí, ¿en mi casa o en la tuya? 😘",
      type: 'sent',
      time: '11:32 PM'
    },
    {
      id: 3,
      content: "En la mía... tengo algo especial planeado 🔥",
      type: 'received',
      time: '11:33 PM'
    },
    {
      id: 4,
      content: "Me intriga... ¿qué tipo de especial? 😈",
      type: 'sent',
      time: '11:34 PM'
    },
    {
    ...
    {
      id: 6,
      content: "Wow... te ves increíble 🔥🔥",
      type: 'sent',
      time: '11:36 PM'
    },
    {
      id: 7,
      content: "Esto es solo el comienzo... espera a ver lo que llevo puesto debajo 😏",
      type: 'received',
      time: '11:37 PM'
    },
    {
      id: 8,
      content: "Me estás volviendo loco... ya salgo 🚗💨",
      type: 'sent',
      time: '11:38 PM'
    },
    {
      id: 9,
      content: "Bien... te estaré esperando en la puerta. No toques, solo entra 😈",
      type: 'received',
      time: '11:39 PM'
    },
    {
      id: 10,
      content: "No puedo esperar a verte... tengo una sorpresa 😈",
      type: 'received',
      time: '11:40 PM'
    },
    {
      id: 11,
      content: "¿Qué tipo de sorpresa? Me estás matando de expectativa 🔥",
      type: 'sent',
      time: '11:41 PM'
    },
    {
      id: 12,
      content: "Ya me estoy preparando... esto va a ser increíble 💋",
      type: 'sent',
      time: '11:42 PM'
    },
    {
      id: 13,
      content: "Digamos que... no te vas a decepcionar. He estado pensando en esto todo el día 😍",
      type: 'received',
      time: '11:43 PM'
    },
    {
      id: 14,
      content: "Yo también... no pude concentrarme en nada más en el trabajo hoy 💭",
      type: 'sent',
      time: '11:44 PM'
    },
    {
      id: 15,
      content: "Bien... porque esta noche va a ser inolvidable 🌙✨",
      type: 'received',
      time: '11:45 PM'
    },
    {
      id: 16,
      content: "Ya casi llego... mi corazón está acelerado 💓",
      type: 'sent',
      time: '11:47 PM'
    },
    {
      id: 17,
      content: "El mío también... no puedo esperar a sentir tu toque otra vez 😘",
      type: 'received',
      time: '11:48 PM'
    },
    {
      id: 18,
      content: "Acabo de llegar... nos vemos en 30 segundos 😏",
      type: 'sent',
      time: '11:50 PM'
    }
  ];
  ...
  const compromisingMessages2: ChatMessage[] = [
    {
      id: 1,
      content: "No puedo dejar de pensar en anoche... 😍",
      type: 'received',
      time: '2:15 AM'
    },
    {
      id: 2,
      content: "Yo tampoco... estuviste increíble 🔥",
      type: 'sent',
      time: '2:17 AM'
    },
    {
      id: 3,
      content: "La forma en que me miraste... todavía me da escalofríos 😊",
      type: 'received',
      time: '2:18 AM'
    },
    {
      id: 4,
      content: "Tienes este efecto en mí que no puedo explicar... es embriagador 💫",
      type: 'sent',
      time: '2:19 AM'
    },
    {
      id: 5,
      content: "¿Cuándo podemos hacerlo otra vez? Ya te extraño...",
      type: 'received',
      time: '2:20 AM'
    },
    {
      id: 6,
      content: "Yo también te extraño... más de lo que debería admitir 💭",
      type: 'sent',
      time: '2:21 AM'
    },
    {
      id: 7,
      content: "Sigo repitiendo cada momento en mi cabeza... especialmente esa cosa que hiciste 😏",
      type: 'received',
      time: '2:22 AM'
    },
    {
      id: 8,
      content: "¿Qué parte? Hubo tantos momentos increíbles 😈",
      type: 'sent',
      time: '2:23 AM'
    },
    {
      id: 9,
      content: "Sabes exactamente qué parte... cuando me susurraste al oído 🔥",
      type: 'received',
      time: '2:24 AM'
    },
    {
    ...
    {
      id: 11,
      content: "OMG... me estás volviendo loco 😈💦",
      type: 'received',
      time: '2:26 AM'
    },
    {
      id: 12,
      content: "No puedo evitarlo... sacas este lado de mí 😍",
      type: 'sent',
      time: '2:27 AM'
    },
    {
      id: 13,
      content: "Amo este lado tuyo... tan apasionado, tan intenso 🔥",
      type: 'received',
      time: '2:28 AM'
    },
    {
      id: 14,
      content: "Solo contigo... me haces sentir cosas que nunca había sentido antes 💕",
      type: 'sent',
      time: '2:29 AM'
    },
    {
      id: 15,
      content: "¿Mañana por la noche? ¿Misma hora, misma pasión? 😘",
      type: 'sent',
      time: '2:30 AM'
    },
    {
      id: 16,
      content: "Sí... pero esta vez, hagámoslo aún más especial 🌹",
      type: 'received',
      time: '2:31 AM'
    },
    {
      id: 17,
      content: "Tengo algunas ideas... cosas que he querido probar contigo 😏",
      type: 'received',
      time: '2:32 AM'
    },
    {
      id: 18,
      content: "Ahora me tienes curioso... y emocionado 😈",
      type: 'sent',
      time: '2:33 AM'
    },
    {
      id: 19,
      content: "Bien... porque mañana por la noche va a ser aún mejor que anoche 🔥",
      type: 'received',
      time: '2:34 AM'
    },
    {
      id: 20,
      content: "No sé cómo es posible... pero confío en ti 💋",
      type: 'sent',
      time: '2:35 AM'
    }
  ];
    ...
    const mockConversations: Conversation[] = [
      {
        ...
        message: "Oye, ¿estás libre esta noche? 😏",
        time: "2m",
        isUnlocked: true
      },
      {
        ...
        message: "No puedo dejar de pensar en anoche... 😍",
        time: "5m",
        isUnlocked: true
      },
      {
      ...
      },
      {
        ...
        message: "¡La fiesta estuvo increíble!",
        time: "2h",
      },
      {
        id: 5,
      ...
      },
      {
        ...
        message: "¡Fue genial conocerte ayer!",
        time: "4h",
      },
      {
        id: 7,
        ...
        message: "¿Puedes enviarme ese enlace?",
        time: "5h",
        muted: true,
      },
      {
        ...
        message: "¡Nos vemos en el gimnasio!",
        time: "6h",
      },
      {
        id: 9,
        ...
        message: "Gracias por la ayuda de hoy",
        time: "7h",
      },
      {
        id: 10,
        ...
        message: "¿Noche de películas este fin de semana?",
        time: "8h",
      },
      {
        id: 11,
        ...
        message: "¡Me encanta tu nueva foto de perfil!",
        time: "9h",
        muted: true,
      },
      {
      ...
      },
      {
        ...
        message: "¡La cena estuvo increíble!",
        time: "11h",
        muted: true,
      },
      {
        ...
        message: "Buena suerte con tu presentación",
        time: "12h",
        muted: true,
      },
      {
        ...
        message: "¡No puedo esperar las vacaciones!",
        time: "13h",
        muted: true,
      },
      {
    ...
    followersData.forEach((follower, index) => {
      if (index < 18) {
        conversations.push({
          ...
          message: index === 0 ? "Oye, ¿estás libre esta noche? 😏" :
            index === 1 ? "No puedo dejar de pensar en anoche... 😍" :
              index < 5 ? "¡Hola! ¿Cómo estás?" :
                index < 10 ? "¡Gracias por la recomendación!" :
                  "Tomemos café pronto",
          time: index === 0 ? "2m" :
            index === 1 ? "5m" :
              index < 5 ? "1h" :
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-black/95 backdrop-blur-xl border-t border-gray-800">
          <div className="max-w-sm mx-auto">
            ...
            <div className="mt-4">
              ...
              >
                🚨 RECUPERAR TODOS LOS MENSAJES ELIMINADOS 🚨
              </Button>
            </div>
          </div>
        </div>
          ...
          <div className="text-center p-6">
            <div className="mb-6">
              ...
              <h2 className="text-xl font-bold text-white mb-3">
                ¡Mensajes Secretos Detectados!
              </h2>
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                Encontramos mensajes ocultos y eliminados en esta conversación. Haz clic abajo para revelar todo el contenido secreto.
              </p>
            </div>
