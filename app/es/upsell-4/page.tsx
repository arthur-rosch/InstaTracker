    ...
    <section className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden">
        ...
        <div className="max-w-sm mx-auto text-center">
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="text-sm font-bold">
              OFERTA POR TIEMPO LIMITADO: {String(timeLeft.hours).padStart(2, '0')}:{String(timeLeft.minutes).padStart(2, '0')}:{String(timeLeft.seconds).padStart(2, '0')}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10 pt-20">
        <div className="max-w-lg mx-auto text-center space-y-6">
            ...
            <div className="relative z-10 space-y-4">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-300 text-sm">
                  ¡Recibe alertas si la persona monitoreada interactúa con ciertos perfiles!
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-white font-semibold text-sm mb-1">Lista Personalizada de Perfiles Prohibidos</h3>
                    <p className="text-gray-300 text-xs">
                      Agrega contactos específicos que quieres monitorear con atención especial y saber instantáneamente cuando hay alguna interacción.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-white font-semibold text-sm mb-1">Notificaciones Instantáneas</h3>
                    <p className="text-gray-300 text-xs">
                      Recibe alertas en tiempo real cuando la persona monitoreada da like, comenta o sigue a alguien de la lista negra.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-white font-semibold text-sm mb-1">Registro Detallado de Interacciones</h3>
                    <p className="text-gray-300 text-xs">
                      Mantén un historial completo con la hora exacta de cada interacción. Conserva un archivo de evidencia de todas las actividades para consulta cuando sea necesario.
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            ACTIVAR PROTECCIÓN LISTA NEGRA
          </Button>
