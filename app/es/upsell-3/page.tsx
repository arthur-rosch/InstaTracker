        ...
        <div className="max-w-lg mx-auto text-center space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-300 leading-relaxed">
              Accede a la cámara de cualquier teléfono en tiempo real
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-2xl hover:bg-white/10 transition-all duration-300">
            ...
            <div className="relative z-10">
              <p className="text-gray-300 text-sm leading-relaxed">
                Monitorea remotamente la cámara de cualquier número de teléfono sin que la persona lo sepa. Transmisión en vivo, no requiere instalación de aplicaciones, 100% invisible.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-left">
              <label className="block text-xs font-medium text-gray-300 mb-2">
                Número de teléfono a monitorear
              </label>
              <Input
                type="tel"
                value={phoneNumber}
            ...
            <div className="text-left">
              ...
              >
                ...
                <option value="both">Ambas Cámaras</option>
              </select>
            </div>
            ...
            <div className="text-left">
              ...
              <select
                ...
                className="w-full h-12 text-base border-2 border-gray-800 bg-gray-900 text-white focus:border-purple-500 rounded-2xl px-4 appearance-none"
              >
                <option value="premium">Acceso Premium (Video y Audio)</option>
                <option value="basic">Acceso Básico (Solo Video)</option>
              </select>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 max-w-2xl mx-auto mt-8">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <div className="relative z-10">
                <h3 className="text-lg font-bold text-white mb-2">100% Anónimo</h3>
                <p className="text-gray-300 text-sm">
                  Tu identidad permanece completamente oculta. La persona no sabrá que está siendo monitoreada.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <div className="relative z-10">
                <h3 className="text-lg font-bold text-white mb-2">Cualquier Teléfono</h3>
                <p className="text-gray-300 text-sm">
                  Funciona con cualquier número de teléfono, independientemente del operador o modelo del dispositivo.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Trust indicators */}
          <p className="text-xs text-gray-400 pt-4">100% Anónimo • Resultados Instantáneos • No Requiere Registro</p>
        </div>
      </div>
    </section>
  )
