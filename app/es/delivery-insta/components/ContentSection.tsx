        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Contenido</h3>
                <p className="text-gray-300 text-sm">Ver Historias, Publicaciones, Compartidos...</p>
              </div>
            </div>
          ...
          <div className="space-y-6 mt-6">
            <div className="space-y-4">
              <h4 className="text-white font-semibold text-base">Tipo de contenido más compartido</h4>
              
              {/* Stories */}
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-gray-300 text-sm">Historias</span>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-gray-300 text-sm">Publicaciones</span>
                  <span className="text-white text-sm font-medium">{Math.floor(Math.random() * 50) + 30}%</span>
                </div>
                <div className="w-full bg-gray-700 rounded-full h-2">
                  <div className="bg-purple-500 h-2 rounded-full" style={{width: `${Math.floor(Math.random() * 50) + 30}%`}}></div>
            ...
            <div className="space-y-4">
              <h4 className="text-white font-semibold text-base">Contenido compartido esta semana</h4>
              <div className="bg-white/5 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-300 text-sm">Total compartidos</span>
                  <span className="text-white font-medium">{Math.floor(Math.random() * 100) + 50}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-300 text-sm">Promedio por día</span>
