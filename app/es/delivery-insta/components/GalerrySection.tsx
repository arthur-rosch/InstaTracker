        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Fotos Sospechosas</h3>
                <p className="text-gray-400 text-sm">Contenido potencialmente comprometedor detectado</p>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="relative aspect-video w-full max-w-md mx-auto rounded-xl overflow-hidden border border-red-500/30 shadow-lg">
              <Image
                src={suspiciousPhoto}
                alt="Contenido sospechoso detectado"
                fill
          ...
          <div className="text-center space-y-3">
            <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4">
              <div className="flex items-center justify-center space-x-2 mb-2">
                ...
                <span className="text-red-400 font-semibold">Alerta de Privacidad</span>
              </div>
              <p className="text-gray-300 text-sm">
                Se ha detectado y capturado contenido potencialmente comprometedor.
              </p>
            </div>

            <div className="space-y-1">
              <p className="text-white font-bold text-xl">1 Foto Sospechosa</p>
              <p className="text-red-400 text-sm">Requiere atención inmediata</p>
              <p className="text-gray-400 text-xs">Última detección: Ahora mismo</p>
            </div>
          </div>
        </div>
      </div>
