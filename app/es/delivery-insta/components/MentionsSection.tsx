        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Estimación de Menciones</h3>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              <h2 className="text-white font-bold text-4xl md:text-5xl mb-2">{mentionsCount} Menciones</h2>
            </div>
            ...
            <div className="text-center space-y-2">
              <p className="text-white text-sm md:text-base font-medium">
                Desbloquea el Centro de Capturas para ver mensajes que
              </p>
              <p className="text-white text-sm md:text-base font-medium">
            ...
            {/* Status */}
            <div className="text-center">
              <p className="text-gray-400 text-sm">Actualizado ahora</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="bg-black/95 border border-white/20 text-white w-[95vw] max-w-lg max-h-[85vh] overflow-hidden">
          <DialogHeader className="flex flex-row items-center justify-between pb-4">
            <DialogTitle className="text-lg md:text-xl font-bold">Personas que te mencionaron ({displayFollowers.length})</DialogTitle>
            <Button
              variant="ghost"
              size="sm"
