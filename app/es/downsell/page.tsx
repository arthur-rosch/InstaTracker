      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-red-600 text-white py-3 px-4">
        <div className="container mx-auto flex items-center justify-center space-x-4">
          <span className="font-semibold text-sm md:text-base">
            🎉 ¡FELICITACIONES! ¡GANASTE 50% DE DESCUENTO! 🎉
          </span>
        </div>
      </div>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
              <p className="text-white text-lg leading-relaxed">
                Tu lugar en la aplicación <span className="text-purple-400 font-bold">Instagram Dossier</span> está garantizado con protección.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6 text-left">
              <p className="text-gray-300 leading-relaxed">
                Sin esta protección, tu aplicación puede funcionar con limitaciones de seguridad y tus datos podrían estar en riesgo. Activa la protección del servidor ahora.
              </p>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Protección completa de tu información y privacidad.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Monitoreo 24/7 y respaldo automático activado.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-white text-xl font-bold">
                ¡Activa la protección ahora y asegura tu acceso!
              </h3>
            </div>
            ...
            <div className="mt-8">
              ...
              >
                🔒 ACTIVAR PROTECCIÓN<br />CON 50% DE DESCUENTO
              </Button>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="bg-gray-800/30 backdrop-blur-xl border border-gray-700 rounded-2xl p-4">
                <div className="flex items-center justify-between">
                  <p className="text-gray-300 text-left">¿Por qué necesito esta protección?</p>
