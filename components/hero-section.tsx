      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div className="flex items-center justify-center space-x-3 mb-6">
            ...
            <span className="text-lg font-semibold text-purple-400">Discover in 1 minute</span>
          </div>
          ...
          <div className="space-y-4">
            <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight">
              ...
              <span className="instagram-gradient-text">Instagram hides from you.</span>
            </h1>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto my-12">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-bold text-white mb-2">Complete Profile</h3>
                <p className="text-gray-300">Access all profile information, photos, followers and more</p>
              </div>
            </div>
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 text-left shadow-2xl hover:bg-white/10 transition-all duration-300 hover:scale-105">
              <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-transparent rounded-2xl"></div>
              <div className="relative z-10">
                <h3 className="text-xl font-bold text-white mb-2">Stories and Messages</h3>
                <p className="text-gray-300">Find out who viewed your stories and access private messages</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="pl-10 h-14 text-lg border-2 border-gray-800 bg-gray-900 text-white placeholder-gray-500 focus:border-purple-500 rounded-2xl"
              ...
              <Button
                ...
                className="h-14 px-8 instagram-gradient hover:opacity-90 text-white font-bold shadow-xl rounded-2xl text-lg min-w-[140px]"
              >
                {isLoading ? (
                  <>
            ...
            <div className="space-y-2">
              <p className="text-sm text-gray-400">100% Anonymous • Instant Results • No Login Required</p>
              <p className="text-xs text-orange-400 font-semibold">⚠️ One query per device • Data saved on device</p>
            </div>
          </div>
