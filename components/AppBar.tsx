...
export default function AppBar({ activeTab = 'explore' }: AppBarProps) {
  return (
    <div className="fixed bottom-4 sm:bottom-6 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-sm px-4 sm:px-0">
      <div className="bg-white/3 backdrop-blur-3xl rounded-3xl px-4 sm:px-8 py-4 shadow-2xl shadow-black/70 before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/12 before:via-white/4 before:to-transparent before:rounded-3xl after:absolute after:inset-0 after:bg-gradient-to-t after:from-transparent after:via-white/3 after:to-white/8 after:rounded-3xl relative overflow-hidden">
